(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-29-nyvroshzlva',
      ...
      this.componentDetectors = [
...

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["project_created"],"depends_on":["workspace_context"]}
        },
...

        {
            ...
            selectors: ["button[aria-label*='menu']","[role='menuitem']"],
            purpose: 'Edit or delete task',
            contextNeeded: ["task_id","action_type"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier","field_purpose":"metadata"},{"field_name":"action_type","selector":"button","extraction_method":"textContent","data_type":"string","required":true,"description":"Action selected","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["aria-label"]},
            relationships: {"triggers":["menu_click"],"affects":["task_action"],"depends_on":["task_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["invite_button"],"affects":["invitation_sent"],"depends_on":["workspace_context"]}
        },
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[name='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii"},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["save_button"],"affects":["profile_updated"],"depends_on":["user_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["card_click"],"affects":["project_detail_view"],"depends_on":[]}
        },

        {
            ...
            relationships: {"triggers":["nav_click"],"affects":["activity_page_view"],"depends_on":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-29-nyvroshzlva] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-29-nyvroshzlva] 📊 Tracking 21 discovered components');
      console.log('[demo-test-apps-2025-10-29-nyvroshzlva] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-29-nyvroshzlva] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-29-nyvroshzlva] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-29-nyvroshzlva] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-29-nyvroshzlva] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
