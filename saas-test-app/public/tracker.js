(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-21-qikz69yn3n',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"form","fields":[{"field_name":"current_step","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Current checkout step","field_purpose":"metadata"},{"field_name":"next_step","selector":"body","extraction_method":"computed-style","data_type":"number","required":true,"description":"Next step number","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":["state:step"]},
            relationships: {"triggers":["step_1_completion"],"affects":["step_2_display"],"depends_on":["plan_selection"]}
        },

        {
            ...
            selectors: ["input[value*='cardNumber']","input[type='text'][placeholder*='card']"],
            purpose: 'Enter payment card number',
            contextNeeded: ["field_completed","validation_status"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[value*='cardNumber']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["focus_event"],"affects":["form_validation"],"depends_on":["checkout_step_2"]}
        },

        {
            ...
            type: 'input',
            pattern_type: 'form_field_focus',
            selectors: ["input[value*='expiry']"],
            purpose: 'Enter card expiry date',
            contextNeeded: ["field_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"expiry_completed","selector":"input[value*='expiry']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry field filled","field_purpose":"pci_protected","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["focus_event"],"affects":["form_validation"],"depends_on":["checkout_step_2"]}
        },

        {
            ...
            type: 'input',
            pattern_type: 'form_field_focus',
            selectors: ["input[value*='cvv']"],
            purpose: 'Enter card CVV',
            contextNeeded: ["field_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"cvv_completed","selector":"input[value*='cvv']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV field filled","field_purpose":"pci_protected","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["focus_event"],"affects":["form_validation"],"depends_on":["checkout_step_2"]}
        },

        {
            ...
            selectors: ["button[onClick*='handleCompleteCheckout']","button[type='submit']"],
            purpose: 'Complete payment and checkout',
            contextNeeded: ["plan","cycle","amount","payment_fields_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"payment_fields_completed","selector":"input","extraction_method":"count","data_type":"array","required":true,"description":"List of completed payment fields","field_purpose":"metadata"},{"field_name":"total_amount","selector":"body","extraction_method":"textContent","data_type":"number","required":true,"description":"Total checkout amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["subscription_creation","success_page_redirect"],"depends_on":["payment_fields_valid"]}
        },

        {
            name: 'CheckoutSuccessDashboardLink',
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href='/dashboard']"],
            purpose: 'Navigate to dashboard after purchase',
            contextNeeded: ["conversion_completed"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"conversion_type","selector":"body","extraction_method":"textContent","data_type":"string","required":true,"description":"Type of conversion completed","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["success_page_view"],"affects":["dashboard_view"],"depends_on":["checkout_completion"]}
        },

        {
            ...
            purpose: 'Navigate to create new project',
            contextNeeded: ["current_project_count","plan_type"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_project_count","selector":"body","extraction_method":"textContent","data_type":"number","required":false,"description":"Number of existing projects","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"paywall_context","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"string","required":true,"description":"What triggered paywall","field_purpose":"metadata"},{"field_name":"current_usage","selector":"[role='dialog']","extraction_method":"textContent","data_type":"number","required":true,"description":"Current resource usage","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            selectors: ["button:has-text('New Task')","button[onClick*='setCreateTaskOpen']"],
...

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form:has(input[value*='taskTitle'])"],
            purpose: 'Create new task',
            contextNeeded: ["title","description","priority","assigned_to","due_date","project_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"task_title","selector":"input[value*='taskTitle']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_priority","selector":"select","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select[value*='taskAssignedTo']","extraction_method":"value","data_type":"string","required":false,"description":"Assigned team member","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["task_creation"],"depends_on":["project_id"]}
        },

        {
            ...
            relationships: {"triggers":["dropdown_change"],"affects":["task_update"],"depends_on":["task_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_trigger',
            selectors: ["button:has-text('Edit')","button[onClick*='setEditTaskOpen']"],
            purpose: 'Open task edit modal',
            contextNeeded: ["task_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to edit","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["button_click"],"affects":["modal_open"],"depends_on":["task_id"]}
        },

        {
            ...
            selectors: ["button:has-text('Delete')","button[onClick*='delete']"],
            purpose: 'Delete task',
            contextNeeded: ["task_id"],
            ...
            relationships: {"triggers":["button_click"],"affects":["task_deletion"],"depends_on":["task_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button:has-text('Archive')"],
            ...
            relationships: {"triggers":["button_click"],"affects":["project_status_change"],"depends_on":["project_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_trigger',
            selectors: ["button:has-text('Invite')","button[onClick*='setInviteDialogOpen']"],
            ...
            relationships: {"triggers":["button_click"],"affects":["modal_open"],"depends_on":["workspace_id"]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form:has(input[value*='inviteEmail'])"],
            purpose: 'Send team invitation',
            contextNeeded: ["email","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[value*='inviteEmail']","extraction_method":"value","data_type":"string","required":true,"description":"Email to invite","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["invitation_creation"],"depends_on":["workspace_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button:has-text('Remove')"],
            ...
            relationships: {"triggers":["button_click"],"affects":["member_removal"],"depends_on":["member_id"]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form:has(input[value*='fullName'])"],
            purpose: 'Update user profile',
            contextNeeded: ["full_name","email"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[value*='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["profile_update"],"depends_on":["user_id"]}
        },

        {
            ...
            relationships: {"triggers":["toggle_click"],"affects":["preference_update"],"depends_on":["user_id"]}
        },

        {
            ...
            contextNeeded: ["source_page","trigger_context"],
            ...
            relationships: {"triggers":["button_click"],"affects":["pricing_page_view"],"depends_on":[]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button:has-text('Manage')"],
            purpose: 'Manage billing settings',
            contextNeeded: ["plan","billing_cycle"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"textContent","data_type":"string","required":true,"description":"Current subscription plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["button_click"],"affects":["billing_portal_open"],"depends_on":["subscription_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button:has-text('Download')"],
            purpose: 'Download invoice PDF',
            contextNeeded: ["invoice_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-invoice-id]","fields":[{"field_name":"invoice_id","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-invoice-id","required":true,"description":"Invoice to download","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["button_click"],"affects":["file_download"],"depends_on":["invoice_id"]}
        },

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"button[aria-selected='true']","extraction_method":"textContent","data_type":"string","required":true,"description":"Previously active tab","field_purpose":"metadata"},{"field_name":"new_tab","selector":"button[role='tab']","extraction_method":"textContent","data_type":"string","required":true,"description":"Newly selected tab","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            contextNeeded: ["project_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Selected project","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href"]},
            relationships: {"triggers":["link_click"],"affects":["project_detail_view"],"depends_on":["project_id"]}
        },

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a:has-text('Back')","button:has-text('Back')"],
            purpose: 'Navigate back to previous page',
            contextNeeded: ["current_page","destination"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_page","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current page path","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["window.location"]},
            relationships: {"triggers":["button_click"],"affects":["page_navigation"],"depends_on":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-21-qikz69yn3n] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-21-qikz69yn3n] 📊 Tracking 27 discovered components');
      console.log('[demo-test-apps-2025-10-21-qikz69yn3n] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-21-qikz69yn3n] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-21-qikz69yn3n] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-21-qikz69yn3n] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-21-qikz69yn3n] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
