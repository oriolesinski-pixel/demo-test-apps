(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-05-v43x97jivwn',
      ...
      this.componentDetectors = [
...

        {
            ...
            type: 'button',
            selectors: [".text-sm",".text-gray-600",".hover:underline"],
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-05-v43x97jivwn');
