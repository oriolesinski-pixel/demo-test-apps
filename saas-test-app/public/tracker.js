(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-19-nwdxued0pr',
      ...
      this.componentDetectors = [
...

        {
            ...
            relationships: {"triggers":["payment_submit"],"affects":["subscription_created"],"depends_on":["form_validation"]}
        },
...

        {
            ...
            relationships: {"triggers":["project_view"],"affects":["task_modal_open"],"depends_on":["project_exists"]}
        },
...

        {
            ...
            relationships: {"triggers":["profile_save"],"affects":["profile_updated"],"depends_on":["user_authenticated"]}
        },
...

        {
            ...
            relationships: {"triggers":["invoice_click"],"affects":["invoice_downloaded"],"depends_on":["invoice_exists"]}
        },

        {
            ...
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"a","fields":[{"field_name":"project_id","selector":"a","extraction_method":"data-attribute","data_type":"string","attribute_name":"href","required":true,"description":"Project ID from URL","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["project_list_view"],"affects":["project_detail_view"],"depends_on":["project_exists"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-19-nwdxued0pr] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-19-nwdxued0pr] 📊 Tracking 21 discovered components');
      console.log('[demo-test-apps-2025-10-19-nwdxued0pr] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-19-nwdxued0pr] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-19-nwdxued0pr] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-19-nwdxued0pr] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-19-nwdxued0pr] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
