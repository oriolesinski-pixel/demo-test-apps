(function(root, factory) {
  ...
  console.log('[demo-test-apps-2025-11-02-mj2dcvjwq3b] 🚀 Analytics tracker script loaded and executing...');
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-11-02-mj2dcvjwq3b',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"form","fields":[{"field_name":"current_step","selector":"[data-step]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-step","required":true,"description":"Current checkout step","field_purpose":"metadata"},{"field_name":"plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan","field_purpose":"preference"},{"field_name":"total_amount","selector":"[data-total]","extraction_method":"textContent","data_type":"number","required":true,"description":"Total checkout amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":["searchParams"]},
...

        {
            ...
            purpose: 'Enter card number',
            contextNeeded: ["field_completed","validation_status"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[value*='cardNumber']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["payment_step_viewed"],"affects":["checkout_completion"],"depends_on":["step_2_active"]}
        },

        {
            ...
            relationships: {"triggers":["card_number_entered"],"affects":["checkout_completion"],"depends_on":["step_2_active"]}
        },

        {
            ...
            relationships: {"triggers":["expiry_entered"],"affects":["checkout_completion"],"depends_on":["step_2_active"]}
        },
...

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href='/pricing']","button[onClick*='router.back']"],
            purpose: 'Return to pricing page',
            contextNeeded: ["current_step","form_data_present"],
            context_collection: {"strategy":"component_props","scope_selector":"body","fields":[{"field_name":"checkout_step","selector":"[data-step]","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Step when abandoned","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["checkout_abandonment"],"affects":["pricing_page_view"],"depends_on":[]}
        },

        {
            name: 'SuccessPageDashboardLink',
            type: 'link',
            pattern_type: 'navigation',
            ...
            relationships: {"triggers":["upgrade_success_viewed"],"affects":["dashboard_view"],"depends_on":["checkout_completed"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_project_count","selector":"[data-project-count]","extraction_method":"textContent","data_type":"number","required":false,"description":"Existing project count","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form:has(input[value*='name'])"],
            purpose: 'Create project with details',
            ...
            relationships: {"triggers":["new_project_clicked"],"affects":["project_created","paywall_check"],"depends_on":["form_validation"]}
        },

        {
            ...
            selectors: ["[role='dialog']:has-text('Upgrade')"],
            purpose: 'Show upgrade prompt at limit',
            contextNeeded: ["trigger_context","current_usage","limit"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"trigger_context","selector":"[data-trigger]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-trigger","required":true,"description":"What triggered paywall","field_purpose":"metadata"},{"field_name":"current_usage","selector":"[data-usage]","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Current resource usage","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["[role='dialog'] a[href='/pricing']","button:has-text('Upgrade')"],
            purpose: 'Navigate to pricing from paywall',
            contextNeeded: ["paywall_context","feature_blocked"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"feature_blocked","selector":"[data-feature]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Feature that triggered paywall","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["paywall_shown"],"affects":["pricing_page_view"],"depends_on":["paywall_modal"]}
        },

        {
            ...
            relationships: {"triggers":["project_view"],"affects":["task_modal_open"],"depends_on":["project_loaded"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"task_title","selector":"input[value*='taskTitle']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_priority","selector":"select[value*='taskPriority']","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select[value*='taskAssignedTo']","extraction_method":"value","data_type":"string","required":false,"description":"Assigned user ID","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["create_task_clicked"],"affects":["task_created"],"depends_on":["project_context"]}
        },

        {
            ...
            relationships: {"triggers":["task_interaction"],"affects":["task_updated","activity_logged"],"depends_on":["task_loaded"]}
        },

        {
            ...
            selectors: ["button:has([data-icon='MoreVertical'])"],
            ...
            relationships: {"triggers":["task_view"],"affects":["menu_displayed"],"depends_on":["task_loaded"]}
        },

        {
            ...
            relationships: {"triggers":["menu_opened"],"affects":["task_deleted"],"depends_on":["task_selected"]}
        },
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[value*='inviteEmail']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email address","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["invite_button_clicked"],"affects":["invitation_sent"],"depends_on":["email_validation"]}
        },

        {
            ...
            relationships: {"triggers":["settings_view"],"affects":["profile_updated"],"depends_on":["form_validation"]}
        },

        {
            ...
            type: 'toggle_switch',
            pattern_type: 'toggle_state',
            selectors: ["button[role='switch']","input[type='checkbox'][aria-checked]"],
            purpose: 'Toggle notification preferences',
            contextNeeded: ["setting_name","previous_state","new_state"],
            context_collection: {"strategy":"component_props","scope_selector":"[data-setting]","fields":[{"field_name":"setting_name","selector":"[data-setting]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-setting","required":true,"description":"Setting being toggled","field_purpose":"preference"},{"field_name":"previous_state","selector":"[role='switch']","extraction_method":"aria-attribute","data_type":"boolean","attribute_name":"aria-checked","required":true,"description":"State before toggle","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["settings_interaction"],"affects":["preferences_saved"],"depends_on":[]}
        },

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href*='/dashboard/settings/billing']"],
            purpose: 'View billing settings',
            contextNeeded: ["current_plan"],
            ...
            relationships: {"triggers":["settings_view"],"affects":["billing_page_view"],"depends_on":[]}
        },

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href='/pricing']:has-text('Upgrade')","button:has([data-icon='Crown'])"],
            purpose: 'Navigate to pricing for upgrade',
...

        {
            ...
            relationships: {"triggers":["settings_view"],"affects":["tab_content_displayed"],"depends_on":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-11-02-mj2dcvjwq3b] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-11-02-mj2dcvjwq3b] 📊 Tracking 25 discovered components');
      console.log('[demo-test-apps-2025-11-02-mj2dcvjwq3b] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-11-02-mj2dcvjwq3b] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-11-02-mj2dcvjwq3b] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-11-02-mj2dcvjwq3b] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    try {
      ...
      console.log('[demo-test-apps-2025-11-02-mj2dcvjwq3b] ✅ AI-Enhanced Analytics tracker initialized successfully');
      console.log('[demo-test-apps-2025-11-02-mj2dcvjwq3b] 📊 Tracking', window.analytics.componentDetectors?.length || 0, 'components');
    } catch (error) {
      console.error('[demo-test-apps-2025-11-02-mj2dcvjwq3b] ❌ Analytics tracker initialization FAILED:', error);
      console.error('[demo-test-apps-2025-11-02-mj2dcvjwq3b] Error details:', error.message, error.stack);
    }
  }
