(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-14-7mrv6pnx9a',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"Cardholder name filled","field_purpose":"pii","anonymize":true},{"field_name":"billing_address_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"Billing address filled","field_purpose":"pii","anonymize":true},{"field_name":"plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan","field_purpose":"metadata"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Billing frequency","field_purpose":"metadata"},{"field_name":"total_amount","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Total payment amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["component_state"]},
...

        {
            ...
            relationships: {"triggers":["success_page_view"],"affects":["dashboard_entry"],"depends_on":["purchase_complete"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace","field_purpose":"metadata"},{"field_name":"current_project_count","selector":"body","extraction_method":"count","data_type":"number","required":false,"description":"Existing project count","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["server_state"]},
            relationships: {"triggers":["dashboard_view"],"affects":["project_form_display"],"depends_on":["workspace_access"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"project_name","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"Project name","field_purpose":"metadata"},{"field_name":"project_description","selector":"textarea","extraction_method":"value","data_type":"string","required":false,"description":"Project description","field_purpose":"metadata"},{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Target workspace","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["component_state"]},
            relationships: {"triggers":["form_submit"],"affects":["project_created","paywall_check"],"depends_on":["workspace_plan"]}
        },

        {
            ...
            selectors: [".modal","[role='dialog']"],
            purpose: 'Show upgrade prompt at limit',
            contextNeeded: ["context","current_usage","limit","plan"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"paywall_context","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"What triggered paywall","field_purpose":"metadata"},{"field_name":"current_usage","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Current resource usage","field_purpose":"metadata"},{"field_name":"usage_limit","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Plan limit reached","field_purpose":"metadata"},{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"User's current plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["component_props"]},
...

        {
            ...
            contextNeeded: ["paywall_context","source"],
            context_collection: {"strategy":"parent_data","scope_selector":"[role='dialog']","fields":[{"field_name":"paywall_source","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"string","required":true,"description":"What triggered paywall","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["modal_context"]},
            relationships: {"triggers":["paywall_view"],"affects":["pricing_page_view"],"depends_on":["limit_reached"]}
        },

        {
            name: 'ProjectDetailTaskCreate',
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button"],
            ...
            relationships: {"triggers":["project_view"],"affects":["task_modal_open"],"depends_on":["project_access"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"task_title","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_description","selector":"textarea","extraction_method":"value","data_type":"string","required":false,"description":"Task description","field_purpose":"metadata"},{"field_name":"task_priority","selector":"select","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select","extraction_method":"value","data_type":"string","required":false,"description":"Assigned team member","field_purpose":"metadata"},{"field_name":"due_date","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":false,"description":"Task due date","field_purpose":"metadata"},{"field_name":"project_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["modal_context"]},
            relationships: {"triggers":["modal_submit"],"affects":["task_created"],"depends_on":["project_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["priority_change"],"affects":["task_updated"],"depends_on":["task_context"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to delete","field_purpose":"metadata"},{"field_name":"project_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["url_params"]},
            relationships: {"triggers":["delete_click"],"affects":["task_deleted"],"depends_on":["task_context"]}
        },

        {
            ...
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"project_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project to archive","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["url_params"]},
            relationships: {"triggers":["archive_click"],"affects":["project_archived"],"depends_on":["project_context"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["component_state"]},
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"workspace_name","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"Workspace name","field_purpose":"metadata"},{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["component_state"]},
...

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"label","fields":[{"field_name":"setting_name","selector":"label","extraction_method":"textContent","data_type":"string","required":true,"description":"Notification setting name","field_purpose":"preference"},{"field_name":"previous_state","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"State before toggle","field_purpose":"preference"},{"field_name":"new_state","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"State after toggle","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":["aria-checked"]},
...

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"button[aria-selected='true']","extraction_method":"textContent","data_type":"string","required":true,"description":"Previous active tab","field_purpose":"metadata"},{"field_name":"new_tab","selector":"button[role='tab']","extraction_method":"textContent","data_type":"string","required":true,"description":"New active tab","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":["aria-selected"]},
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace","field_purpose":"metadata"},{"field_name":"current_member_count","selector":"body","extraction_method":"count","data_type":"number","required":false,"description":"Existing team size","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["server_state"]},
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email","field_purpose":"pii","anonymize":true},{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Target workspace","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["modal_context"]},
            relationships: {"triggers":["invite_submit"],"affects":["invitation_sent"],"depends_on":["workspace_context"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-member-id]","fields":[{"field_name":"member_id","selector":"[data-member-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-member-id","required":true,"description":"Member to remove","field_purpose":"metadata"},{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["component_state"]},
            relationships: {"triggers":["remove_click"],"affects":["member_removed"],"depends_on":["member_context"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"User's current plan","field_purpose":"metadata"},{"field_name":"source_page","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Page triggering upgrade","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["url_path"]},
            relationships: {"triggers":["billing_view"],"affects":["pricing_page_view"],"depends_on":["plan_context"]}
        },

        {
            ...
            relationships: {"triggers":["download_click"],"affects":["invoice_downloaded"],"depends_on":["invoice_context"]}
        },

        {
            ...
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"a","extraction_method":"data-attribute","data_type":"string","attribute_name":"href","required":true,"description":"Target project ID","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href_attribute"]},
...

        {
            ...
            contextNeeded: ["current_plan","source"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"User's current plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["server_state"]},
            relationships: {"triggers":["dashboard_view"],"affects":["pricing_page_view"],"depends_on":["plan_context"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-14-7mrv6pnx9a] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-14-7mrv6pnx9a] 📊 Tracking 25 discovered components');
      console.log('[demo-test-apps-2025-12-14-7mrv6pnx9a] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-14-7mrv6pnx9a] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-14-7mrv6pnx9a] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-14-7mrv6pnx9a] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-14-7mrv6pnx9a] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
