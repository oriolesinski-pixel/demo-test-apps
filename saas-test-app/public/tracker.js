(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-21-44gofqbopnd',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[name='cardNumber']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[name='expiry']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[name='cvv']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name","selector":"input[name='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card","field_purpose":"pii","anonymize":true},{"field_name":"billing_address_completed","selector":"input[name='billingAddress']","extraction_method":"value","data_type":"boolean","required":true,"description":"Billing address filled","field_purpose":"pii","anonymize":true},{"field_name":"plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan","field_purpose":"metadata"},{"field_name":"total_amount","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Total payment amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["form_validation","payment_processing"],"affects":["subscription_creation","success_page_redirect"],"depends_on":["step_2_completion"]}
        },

        {
            ...
            contextNeeded: ["upgrade_completed","plan"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"upgrade_completed","selector":"body","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"Upgrade success status","field_purpose":"metadata"},{"field_name":"plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Upgraded plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["localStorage"]},
            relationships: {"triggers":["dashboard_navigation"],"affects":["dashboard_load"],"depends_on":["payment_success"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_project_count","selector":"body","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Current active projects","field_purpose":"metadata"},{"field_name":"workspace_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Current workspace plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["serverData"]},
            relationships: {"triggers":["project_form_load"],"affects":["project_creation_flow"],"depends_on":["workspace_access"]}
        },
...

        {
            ...
            contextNeeded: ["project_name","description","workspace_id","project_count"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"project_name","selector":"input[name='name']","extraction_method":"value","data_type":"string","required":true,"description":"Project name","field_purpose":"metadata"},{"field_name":"project_description","selector":"textarea[name='description']","extraction_method":"value","data_type":"string","required":false,"description":"Project description","field_purpose":"metadata"},{"field_name":"current_project_count","selector":"body","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Projects before creation","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["project_creation","paywall_check"],"affects":["project_list","activity_log"],"depends_on":["workspace_membership"]}
        },
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"body","fields":[{"field_name":"project_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project ID","field_purpose":"metadata"},{"field_name":"project_name","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Parent project name","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["params"]},
            relationships: {"triggers":["task_modal_open"],"affects":["task_form_display"],"depends_on":["project_access"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"task_title","selector":"input[name='title']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_description","selector":"textarea[name='description']","extraction_method":"value","data_type":"string","required":false,"description":"Task description","field_purpose":"metadata"},{"field_name":"priority","selector":"select[name='priority']","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select[name='assignedTo']","extraction_method":"value","data_type":"string","required":false,"description":"Assigned team member","field_purpose":"metadata"},{"field_name":"due_date","selector":"input[name='dueDate']","extraction_method":"value","data_type":"string","required":false,"description":"Task due date","field_purpose":"metadata"},{"field_name":"project_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["task_creation"],"affects":["task_list","activity_log"],"depends_on":["project_access"]}
        },

        {
            ...
            relationships: {"triggers":["status_update"],"affects":["task_state","activity_log"],"depends_on":["task_access"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to delete","field_purpose":"metadata"},{"field_name":"task_title","selector":"[data-task-id]","extraction_method":"textContent","data_type":"string","required":false,"description":"Task name","field_purpose":"metadata"},{"field_name":"project_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["params"]},
            relationships: {"triggers":["task_deletion"],"affects":["task_list","activity_log"],"depends_on":["task_access"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"body","fields":[{"field_name":"project_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project to archive","field_purpose":"metadata"},{"field_name":"project_name","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Project name","field_purpose":"metadata"},{"field_name":"task_count","selector":"body","extraction_method":"count","data_type":"number","required":false,"description":"Tasks in project","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["state"]},
            relationships: {"triggers":["project_archival"],"affects":["project_list","activity_log"],"depends_on":["project_access"]}
        },
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email","field_purpose":"pii","anonymize":true},{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace ID","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["invitation_creation"],"affects":["invitation_list","activity_log"],"depends_on":["workspace_access"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-member-id]","fields":[{"field_name":"member_id","selector":"[data-member-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-member-id","required":true,"description":"Member to remove","field_purpose":"metadata"},{"field_name":"member_email","selector":"[data-member-id]","extraction_method":"textContent","data_type":"string","required":false,"description":"Member email","field_purpose":"pii","anonymize":true},{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace ID","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["state"]},
            relationships: {"triggers":["member_removal"],"affects":["member_list","activity_log"],"depends_on":["workspace_admin"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[name='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["profile_update"],"affects":["user_profile","activity_log"],"depends_on":["user_authentication"]}
        },

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"[role='switch']","fields":[{"field_name":"notification_type","selector":"[role='switch']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-notification-type","required":true,"description":"Type of notification","field_purpose":"preference"},{"field_name":"previous_state","selector":"[role='switch']","extraction_method":"aria-attribute","data_type":"boolean","attribute_name":"aria-checked","required":true,"description":"State before toggle","field_purpose":"preference"},{"field_name":"new_state","selector":"[role='switch']","extraction_method":"aria-attribute","data_type":"boolean","attribute_name":"aria-checked","required":true,"description":"State after toggle","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":["checked"]},
            relationships: {"triggers":["preference_update"],"affects":["notification_settings"],"depends_on":["user_authentication"]}
        },

        {
            ...
            pattern_type: 'navigation',
            selectors: ["button"],
            purpose: 'Manage subscription details',
            contextNeeded: ["current_plan","billing_cycle","workspace_id"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Active plan","field_purpose":"metadata"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Billing frequency","field_purpose":"metadata"},{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace ID","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["state"]},
            relationships: {"triggers":["billing_portal_open"],"affects":["subscription_management"],"depends_on":["active_subscription"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-invoice-id]","fields":[{"field_name":"invoice_id","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-invoice-id","required":true,"description":"Invoice identifier","field_purpose":"metadata"},{"field_name":"invoice_date","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-invoice-date","required":false,"description":"Invoice date","field_purpose":"metadata"},{"field_name":"amount","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-amount","required":false,"description":"Invoice amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["state"]},
            relationships: {"triggers":["invoice_download"],"affects":["file_download"],"depends_on":["invoice_access"]}
        },

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"[role='tab'][aria-selected='true']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-tab-id","required":true,"description":"Previous active tab","field_purpose":"metadata"},{"field_name":"new_tab","selector":"[role='tab']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-tab-id","required":true,"description":"New active tab","field_purpose":"metadata"},{"field_name":"has_unsaved_changes","selector":"form","extraction_method":"data-attribute","data_type":"boolean","attribute_name":"data-dirty","required":false,"description":"Unsaved form changes","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":["aria-selected"]},
            relationships: {"triggers":["tab_content_change"],"affects":["visible_settings"],"depends_on":["settings_access"]}
        },

        {
            name: 'ProjectCardClick',
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href*='/dashboard/projects/']"],
            purpose: 'Navigate to project detail',
            contextNeeded: ["project_id","project_name","task_count"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project identifier","field_purpose":"metadata"},{"field_name":"project_name","selector":"[data-project-id]","extraction_method":"textContent","data_type":"string","required":false,"description":"Project name","field_purpose":"metadata"},{"field_name":"task_count","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-task-count","required":false,"description":"Number of tasks","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href"]},
            relationships: {"triggers":["project_detail_load"],"affects":["project_view"],"depends_on":["project_access"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-21-44gofqbopnd] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-21-44gofqbopnd] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-10-21-44gofqbopnd] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-21-44gofqbopnd] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-21-44gofqbopnd] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-21-44gofqbopnd] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-21-44gofqbopnd] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
