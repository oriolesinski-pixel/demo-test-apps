(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2026-02-20-xequmir80og',
      ...
      this.componentDetectors = [
...

        {
            ...
            selectors: ["form button[type='submit']",".complete-checkout-btn"],
            purpose: 'Submit payment and complete checkout',
            contextNeeded: ["plan","billing_cycle","amount","payment_fields_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"payment_fields_completed","selector":"input","extraction_method":"count","data_type":"array","required":true,"description":"List of completed payment fields","field_purpose":"pci_protected","anonymize":true},{"field_name":"plan","selector":"url","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan"},{"field_name":"billing_cycle","selector":"url","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Billing frequency"},{"field_name":"total_amount","selector":".total","extraction_method":"textContent","data_type":"number","required":true,"description":"Total checkout amount"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["form_submit"],"affects":["subscription_status","workspace_plan"],"depends_on":["payment_validation"]},
            // Form collection detection - for buttons that submit forms
        ...
        {
            name: 'CheckoutSuccessContinueButton',
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href*='dashboard']",".continue-dashboard-btn"],
            purpose: 'Navigate to dashboard after upgrade',
            contextNeeded: ["upgrade_completed","plan"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"upgrade_completed","selector":"body","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"Upgrade success state"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["page_navigation"],"depends_on":["checkout_completion"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href*='/projects/new']","button:has-text('New Project')"],
            purpose: 'Navigate to project creation',
            contextNeeded: ["current_project_count","workspace_plan"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_project_count","selector":"[data-project-count]","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Current active projects"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["page_navigation"],"depends_on":["workspace_access"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["form button[type='submit']",".create-project-submit"],
            ...
            relationships: {"triggers":["form_submit"],"affects":["project_list","activity_log"],"depends_on":["workspace_membership"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
...

        {
            ...
            selectors: ["[role='dialog']",".paywall-modal"],
            purpose: 'Show upgrade prompt at limit',
            contextNeeded: ["trigger_context","current_usage","limit"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"trigger_context","selector":"[data-context]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"What triggered paywall"},{"field_name":"current_usage","selector":"[data-usage]","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Current resource usage"},{"field_name":"limit","selector":"[data-limit]","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Plan limit reached"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["limit_reached"],"affects":["user_awareness"],"depends_on":["plan_limits"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: [".paywall-modal button[href*='pricing']",".upgrade-now-btn"],
            purpose: 'Navigate to pricing from paywall',
            contextNeeded: ["paywall_context","current_usage","limit"],
            context_collection: {"strategy":"parent_data","scope_selector":"[role='dialog']","fields":[{"field_name":"paywall_context","selector":"[data-context]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Paywall trigger reason"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["page_navigation"],"depends_on":["paywall_display"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            selectors: ["button:has-text('Create Task')",".create-task-btn"],
            purpose: 'Open task creation modal',
            contextNeeded: ["project_id"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"project_id","selector":"url","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current project ID"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["modal_visibility"],"depends_on":["project_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["[role='dialog'] form button[type='submit']",".submit-task-btn"],
            purpose: 'Create new task',
            contextNeeded: ["title","description","priority","assigned_to","due_date","project_id"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"project_id","selector":"url","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project ID"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["form_submit"],"affects":["task_list","activity_log"],"depends_on":["project_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
            form_schema: {"form_name":"CreateTaskForm","form_selector":"[role='dialog'] form","fields":[{"field_name":"taskTitle","field_label":"Task Title","field_type":"text","required":true,"is_sensitive":false},{"field_name":"taskDescription","field_label":"Description","field_type":"textarea","required":false,"is_sensitive":false},{"field_name":"taskPriority","field_label":"Priority","field_type":"select","required":false,"is_sensitive":false},{"field_name":"taskAssignedTo","field_label":"Assigned To","field_type":"select","required":false,"is_sensitive":false},{"field_name":"taskDueDate","field_label":"Due Date","field_type":"date","required":false,"is_sensitive":false}],"submit_button_selector":"button[type='submit']"}
        },

        {
            ...
            selectors: ["[role='combobox']",".task-status-select"],
            ...
            relationships: {"triggers":["dropdown_change"],"affects":["task_state","activity_log"],"depends_on":["task_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_trigger',
            selectors: ["button:has-text('Edit')","[data-action='edit']"],
            purpose: 'Open task edit modal',
            contextNeeded: ["task_id","project_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to edit"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["modal_visibility"],"depends_on":["task_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            selectors: ["button:has-text('Delete')","[data-action='delete']"],
            purpose: 'Delete task',
            ...
            relationships: {"triggers":["user_click"],"affects":["task_list","activity_log"],"depends_on":["task_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"project_id","selector":"url","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project to archive"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["project_status","activity_log"],"depends_on":["project_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },
...

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["[role='dialog'] form button[type='submit']",".send-invite-btn"],
            purpose: 'Send team invitation',
            contextNeeded: ["email","workspace_id"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["form_submit"],"affects":["invitation_list","activity_log"],"depends_on":["workspace_membership"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
            form_schema: {"form_name":"TeamInviteForm","form_selector":"[role='dialog'] form","fields":[{"field_name":"inviteEmail","field_label":"Email Address","field_type":"email","required":true,"is_sensitive":false}],"submit_button_selector":"button[type='submit']"}
        },

        {
            ...
            relationships: {"triggers":["user_click"],"affects":["team_list","activity_log"],"depends_on":["member_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["form button[type='submit']",".save-profile-btn"],
            ...
            relationships: {"triggers":["form_submit"],"affects":["user_profile","activity_log"],"depends_on":["user_authentication"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
...

        {
            ...
            type: 'toggle_switch',
            pattern_type: 'toggle_state',
            selectors: ["[role='switch']",".notification-toggle"],
            purpose: 'Toggle notification preferences',
            contextNeeded: ["preference_type","previous_state","new_state"],
            context_collection: {"strategy":"component_props","scope_selector":"[role='switch']","fields":[{"field_name":"preference_type","selector":"[data-preference]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-preference","required":true,"description":"Type of notification"},{"field_name":"previous_state","selector":"[role='switch']","extraction_method":"aria-attribute","data_type":"boolean","attribute_name":"aria-checked","required":true,"description":"State before toggle"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false}},
            relationships: {"triggers":["toggle_click"],"affects":["user_preferences"],"depends_on":["settings_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"url","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Page where upgrade clicked"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["page_navigation"],"depends_on":["workspace_plan"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button:has-text('Manage')",".manage-billing-btn"],
            purpose: 'Manage billing settings',
            contextNeeded: ["current_plan","billing_cycle"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"[data-plan]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Active subscription plan"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["billing_portal"],"depends_on":["subscription_status"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            relationships: {"triggers":["user_click"],"affects":["file_download"],"depends_on":["invoice_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },
...

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href*='/projects/']",".project-card"],
            purpose: 'Navigate to project detail',
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project identifier"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["page_navigation"],"depends_on":["project_list"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"url","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current page path"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["user_click"],"affects":["page_navigation"],"depends_on":["navigation_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        }
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2026-02-20-xequmir80og] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2026-02-20-xequmir80og] 📊 Tracking 24 discovered components');
      console.log('[demo-test-apps-2026-02-20-xequmir80og] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2026-02-20-xequmir80og] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2026-02-20-xequmir80og] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2026-02-20-xequmir80og] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2026-02-20-xequmir80og] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
