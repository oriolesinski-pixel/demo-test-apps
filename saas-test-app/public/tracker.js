(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2026-02-19-8fw2kct09or',
      ...
      this.componentDetectors = [
        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"plan","selector":"url_param","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan type"},{"field_name":"billing_cycle","selector":"url_param","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Monthly or annual"},{"field_name":"step","selector":"state","extraction_method":"value","data_type":"number","required":true,"description":"Current checkout step"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["step_change"],"affects":["checkout_step_viewed"],"depends_on":["plan_selection"]},
...

        {
            ...
            contextNeeded: ["plan","billing_cycle","total","card_number","expiry","cvv","cardholder_name","billing_address","city","state","zip"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"plan","selector":"url_param","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan","field_purpose":"metadata"},{"field_name":"billing_cycle","selector":"url_param","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Billing frequency","field_purpose":"metadata"},{"field_name":"total_amount","selector":"state","extraction_method":"value","data_type":"number","required":true,"description":"Total payment amount","field_purpose":"metadata"},{"field_name":"payment_fields_completed","selector":"form input","extraction_method":"count","data_type":"array","required":true,"description":"List of completed payment fields","field_purpose":"pci_protected","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["payment_processing"],"affects":["subscription_created"],"depends_on":["form_validation"]},
            // Form collection detection - for buttons that submit forms
...

        {
            ...
            contextNeeded: ["source_page","user_plan"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"window.location.pathname","extraction_method":"value","data_type":"string","required":true,"description":"Current page path"},{"field_name":"current_plan","selector":"data-plan","extraction_method":"data-attribute","data_type":"string","required":false,"description":"User's current plan"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["page_navigation"],"affects":["pricing_page_viewed"],"depends_on":[]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            purpose: 'Navigate to create project form',
            contextNeeded: ["source_page","project_count"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"window.location.pathname","extraction_method":"value","data_type":"string","required":true,"description":"Current page"},{"field_name":"current_project_count","selector":"data-project-count","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Existing project count"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["navigation"],"affects":["project_form_viewed"],"depends_on":[]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },
...

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button:has-text('Create Task')","button[type='submit']"],
            purpose: 'Create new task in project',
            contextNeeded: ["task_title","task_description","task_priority","task_assigned_to","task_due_date","project_id"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"task_title","selector":"input","extraction_method":"value","data_type":"string","required":true,"description":"Task title"},{"field_name":"task_description","selector":"textarea","extraction_method":"value","data_type":"string","required":false,"description":"Task description"},{"field_name":"task_priority","selector":"select","extraction_method":"value","data_type":"string","required":false,"description":"Priority level"},{"field_name":"assigned_to","selector":"select[name='assignedTo']","extraction_method":"value","data_type":"string","required":false,"description":"Assigned user ID"},{"field_name":"project_id","selector":"url_param","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project ID"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["task_creation"],"affects":["task_list","activity_log"],"depends_on":["project_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
...

        {
            ...
            type: 'select_dropdown',
            pattern_type: 'toggle_state',
            selectors: ["select[name='priority']","[data-priority-select]"],
            purpose: 'Change task priority',
            contextNeeded: ["task_id","previous_priority","new_priority"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","attribute_name":"data-task-id","data_type":"string","required":true,"description":"Task ID"},{"field_name":"previous_priority","selector":"select","extraction_method":"value","data_type":"string","required":true,"description":"Priority before change"},{"field_name":"new_priority","selector":"select","extraction_method":"value","data_type":"string","required":true,"description":"Priority after change"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false}},
...

        {
            ...
            selectors: ["button:has-text('Edit')","[data-action='edit-project']"],
            purpose: 'Open edit project modal',
            contextNeeded: ["project_id","project_name","project_description"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","attribute_name":"data-project-id","data_type":"string","required":true,"description":"Project ID"},{"field_name":"project_name","selector":"h1, [data-project-name]","extraction_method":"textContent","data_type":"string","required":true,"description":"Current project name"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["modal_open"],"affects":["modal_state"],"depends_on":["project_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            selectors: ["button:has-text('Archive')","[data-action='archive']"],
            purpose: 'Archive project',
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","attribute_name":"data-project-id","data_type":"string","required":true,"description":"Project to archive"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["project_archive"],"affects":["project_status","activity_log"],"depends_on":["project_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button:has-text('Delete')","[data-action='delete-task']"],
            purpose: 'Delete task',
            contextNeeded: ["task_id","task_title","project_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","attribute_name":"data-task-id","data_type":"string","required":true,"description":"Task to delete"},{"field_name":"task_title","selector":"[data-task-title]","extraction_method":"textContent","data_type":"string","required":false,"description":"Task name"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["task_deletion"],"affects":["task_list","activity_log"],"depends_on":["task_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button:has-text('Invite')","button:has-text('Invite Member')"],
            purpose: 'Open invite member modal',
            contextNeeded: ["workspace_id","current_member_count"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"data-workspace-id","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace ID"},{"field_name":"member_count","selector":"data-member-count","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Current team size"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["modal_open"],"affects":["modal_state"],"depends_on":[]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button[type='submit']","button:has-text('Send Invite')"],
            purpose: 'Send team invitation',
            contextNeeded: ["invite_email","workspace_id"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["invitation_sent"],"affects":["invitation_list","activity_log"],"depends_on":["workspace_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
...

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button:has-text('Remove')","[data-action='remove-member']"],
            purpose: 'Remove team member',
            contextNeeded: ["member_id","member_email","workspace_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-member-id]","fields":[{"field_name":"member_id","selector":"[data-member-id]","extraction_method":"data-attribute","attribute_name":"data-member-id","data_type":"string","required":true,"description":"Member to remove"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["member_removal"],"affects":["team_list","activity_log"],"depends_on":["member_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button[type='submit']","button:has-text('Save')"],
            purpose: 'Update user profile',
            contextNeeded: ["full_name","email"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[name='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true}},
            relationships: {"triggers":["profile_update"],"affects":["user_profile","activity_log"],"depends_on":["form_validation"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
            form_schema: {"form_name":"ProfileSettingsForm","form_selector":"form","fields":[{"field_name":"fullName","field_label":"Full Name","field_type":"text","required":true,"is_sensitive":false},{"field_name":"email","field_label":"Email","field_type":"email","required":true,"is_sensitive":true}],"submit_button_selector":"button[type='submit']"}
        },

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"[data-notification-type]","fields":[{"field_name":"notification_type","selector":"[data-notification-type]","extraction_method":"data-attribute","attribute_name":"data-notification-type","data_type":"string","required":true,"description":"Type of notification"},{"field_name":"previous_state","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"State before toggle"},{"field_name":"new_state","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"State after toggle"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false}},
            relationships: {"triggers":["preference_change"],"affects":["user_preferences"],"depends_on":[]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            selectors: ["[role='tab']","button[data-tab]"],
            purpose: 'Switch settings tab',
            contextNeeded: ["previous_tab","new_tab","unsaved_changes"],
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"[role='tab'][aria-selected='true']","extraction_method":"data-attribute","attribute_name":"data-tab","data_type":"string","required":true,"description":"Previous active tab"},{"field_name":"new_tab","selector":"[role='tab']","extraction_method":"data-attribute","attribute_name":"data-tab","data_type":"string","required":true,"description":"New active tab"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false}},
...

        {
            ...
            purpose: 'Navigate to upgrade flow',
            contextNeeded: ["source_page","current_plan","trigger_context"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"window.location.pathname","extraction_method":"value","data_type":"string","required":true,"description":"Page where upgrade clicked"},{"field_name":"current_plan","selector":"data-plan","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Current subscription plan"},{"field_name":"trigger_context","selector":"data-trigger","extraction_method":"data-attribute","data_type":"string","required":false,"description":"What triggered upgrade prompt"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["navigation"],"affects":["pricing_page_viewed"],"depends_on":[]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },
        ...
        {
            name: 'ManageBillingButton',
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button:has-text('Manage Billing')","a[href*='billing']"],
            purpose: 'Navigate to billing page',
            contextNeeded: ["current_plan","billing_cycle"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"data-plan","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Active plan"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["navigation"],"affects":["billing_page_viewed"],"depends_on":[]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button:has-text('Download')","[data-action='download-invoice']"],
            purpose: 'Download invoice PDF',
            contextNeeded: ["invoice_id","invoice_date","invoice_amount"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-invoice-id]","fields":[{"field_name":"invoice_id","selector":"[data-invoice-id]","extraction_method":"data-attribute","attribute_name":"data-invoice-id","data_type":"string","required":true,"description":"Invoice identifier"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["file_download"],"affects":[],"depends_on":["invoice_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","attribute_name":"data-project-id","data_type":"string","required":true,"description":"Project ID"},{"field_name":"project_name","selector":"h3, [data-project-name]","extraction_method":"textContent","data_type":"string","required":false,"description":"Project name"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["navigation"],"affects":["project_detail_viewed"],"depends_on":[]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            contextNeeded: ["source_page"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"window.location.pathname","extraction_method":"value","data_type":"string","required":true,"description":"Current page"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["navigation"],"affects":["dashboard_viewed"],"depends_on":[]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button:has-text('Get Started')","a[href*='dashboard']"],
            purpose: 'Navigate to dashboard after success',
            contextNeeded: ["source_page","plan"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"window.location.pathname","extraction_method":"value","data_type":"string","required":true,"description":"Success page"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["navigation"],"affects":["dashboard_viewed"],"depends_on":["checkout_completion"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        }
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2026-02-19-8fw2kct09or] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2026-02-19-8fw2kct09or] 📊 Tracking 23 discovered components');
      console.log('[demo-test-apps-2026-02-19-8fw2kct09or] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2026-02-19-8fw2kct09or] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2026-02-19-8fw2kct09or] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2026-02-19-8fw2kct09or] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2026-02-19-8fw2kct09or] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
