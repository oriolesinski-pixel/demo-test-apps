(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-18-md8av39d4tj',
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-18-md8av39d4tj] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-18-md8av39d4tj] 📊 Tracking 0 discovered components');
      console.log('[demo-test-apps-2025-12-18-md8av39d4tj] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-18-md8av39d4tj] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-18-md8av39d4tj] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-18-md8av39d4tj] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-18-md8av39d4tj] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
