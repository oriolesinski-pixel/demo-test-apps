(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-21-ysgm8jyjyad',
      ...
      this.componentDetectors = [
...

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["modal_open"],"depends_on":["project_view"]}
        },

        {
            ...
            contextNeeded: ["task_title","description","priority","assigned_to","due_date"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"task_title","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_description","selector":"textarea","extraction_method":"value","data_type":"string","required":false,"description":"Task description","field_purpose":"metadata"},{"field_name":"priority","selector":"select","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select","extraction_method":"value","data_type":"string","required":false,"description":"Assigned team member","field_purpose":"metadata"},{"field_name":"due_date","selector":"input[type='date']","extraction_method":"value","data_type":"string","required":false,"description":"Task due date","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["select_change"],"affects":["task_updated"],"depends_on":["task_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["dropdown_click"],"affects":["project_archived"],"depends_on":["project_context"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace","field_purpose":"metadata"},{"field_name":"member_count","selector":".card","extraction_method":"count","data_type":"number","required":false,"description":"Current team size","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["button_click"],"affects":["modal_open"],"depends_on":["workspace_access"]}
        },
...

        {
            ...
            relationships: {"triggers":["dropdown_click"],"affects":["member_removed"],"depends_on":["member_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["toggle_click"],"affects":["preferences_updated"],"depends_on":["user_context"]}
        },
...

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href*='/checkout']","button"],
            purpose: 'Navigate to upgrade checkout',
            contextNeeded: ["current_plan","workspace_id"],
            ...
            relationships: {"triggers":["button_click"],"affects":["checkout_flow"],"depends_on":["billing_context"]}
        },
...

        {
            ...
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":".card","fields":[{"field_name":"project_id","selector":"a","extraction_method":"data-attribute","data_type":"string","attribute_name":"href","required":true,"description":"Project identifier","field_purpose":"metadata"},{"field_name":"project_name","selector":".card-title","extraction_method":"textContent","data_type":"string","required":false,"description":"Project name","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["card_click"],"affects":["project_detail_view"],"depends_on":["project_list"]}
        },

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href='/dashboard/activity']"],
            purpose: 'Navigate to activity feed',
            ...
            relationships: {"triggers":["nav_click"],"affects":["activity_page_view"],"depends_on":["workspace_context"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-21-ysgm8jyjyad] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-21-ysgm8jyjyad] 📊 Tracking 23 discovered components');
      console.log('[demo-test-apps-2025-12-21-ysgm8jyjyad] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-21-ysgm8jyjyad] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-21-ysgm8jyjyad] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-21-ysgm8jyjyad] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-21-ysgm8jyjyad] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
