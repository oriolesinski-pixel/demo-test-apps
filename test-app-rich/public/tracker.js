(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-05-xbx1eymp5i',
      ...
      this.componentDetectors = [
...

        {
            ...
            purpose: 'Navigate to login, register, product, cart, wishlist pages',
            contextNeeded: null,
...

        {
            ...
            purpose: 'Login, Register form fields',
            contextNeeded: ["email","password","name","confirmPassword"],
...

        {
            name: 'Button',
            type: 'button',
            selectors: [".p-1.hover:bg-gray-100.rounded",".text-red-500.hover:text-red-700"],
            purpose: 'Increase/Decrease quantity, Remove from cart',
...

        {
            ...
            contextCollection: {"search_parents":null,"extract_fields":["email","password","name","confirmPassword","firstName","lastName","phone","address","city","state","zipCode","country"],"sibling_context":null,"data_attributes":null}
        },

        {
            name: 'Button',
            type: 'button',
            selectors: [".bg-white/30.hover:bg-white/50.text-white.p-2.rounded-full.backdrop-blur-sm.transition-colors"],
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-05-xbx1eymp5i');
