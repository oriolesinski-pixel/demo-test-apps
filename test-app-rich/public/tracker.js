(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-06-uystena94uf',
      ...
      this.componentDetectors = [
        {
            ...
            contextCollection: {"search_parents":[".login-form"],"extract_fields":["email","password"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["productId","quantity"],"sibling_context":["input[name='size']",".color-selector.active"],"data_attributes":["data-product-id","data-sku"]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-06-uystena94uf');
