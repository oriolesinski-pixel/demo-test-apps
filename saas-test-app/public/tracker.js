(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-15-2d0wld4sd7j',
      ...
      this.componentDetectors = [
...

        {
            ...
            relationships: {"triggers":["modal_opened"],"affects":["modal visibility"],"depends_on":["project context"]}
        },
...

        {
            ...
            relationships: {"triggers":["dropdown_opened"],"affects":["dropdown visibility"],"depends_on":["task context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label='Delete task']"],
            purpose: 'Delete task',
...

        {
            ...
            selectors: ["button[aria-label='Edit project']"],
...

        {
            ...
            selectors: ["button[aria-label='Archive project']"],
            purpose: 'Archive project',
            contextNeeded: ["project_id","project_name","previous_status"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project to archive"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":["dropdown menu context"]},
...

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button[aria-label='Invite member']"],
            purpose: 'Open invite team member modal',
...

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label='Remove member']"],
...

        {
            ...
            relationships: {"triggers":["upgrade_clicked"],"affects":["page navigation"],"depends_on":["current plan"]}
        },
...

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label='Manage subscription']"],
            purpose: 'Open subscription management',
            ...
            relationships: {"triggers":["subscription_management_opened"],"affects":["modal visibility"],"depends_on":["subscription status"]}
        },
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-15-2d0wld4sd7j] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-15-2d0wld4sd7j] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-10-15-2d0wld4sd7j] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-15-2d0wld4sd7j] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-15-2d0wld4sd7j] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-15-2d0wld4sd7j] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-15-2d0wld4sd7j] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
