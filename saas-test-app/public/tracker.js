(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-15-et0geg45i4q',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier"},{"field_name":"previous_priority","selector":"select[name='priority']","extraction_method":"value","data_type":"string","required":true,"description":"Priority before change"},{"field_name":"new_priority","selector":"select[name='priority']","extraction_method":"value","data_type":"string","required":true,"description":"Priority after change"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["task_priority_changed"],"affects":["task priority"],"depends_on":["task_id"]}
        },

        {
            ...
            selectors: ["button[aria-label='Edit task']"],
            purpose: 'Open edit task modal',
            contextNeeded: ["task_id","current_task_data"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to edit"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":["closest task container"]},
            relationships: {"triggers":["edit_modal_opened"],"affects":["modal state"],"depends_on":["task_id"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to delete"},{"field_name":"task_title","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-title","required":false,"description":"Task title for logging"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["textContent"]},
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project to archive"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["URL params"]},
...

        {
            ...
            contextNeeded: ["workspace_id","modal_opened"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-workspace-id","required":true,"description":"Current workspace"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["localStorage"]},
            relationships: {"triggers":["invite_modal_opened"],"affects":["modal visibility"],"depends_on":["workspace_id"]}
        },

        {
            ...
            relationships: {"triggers":["invited_member"],"affects":["team members list"],"depends_on":["workspace_id"]}
        },

        {
            ...
            relationships: {"triggers":["member_removed"],"affects":["team members list"],"depends_on":["member_id","workspace_id"]}
        },
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[name='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name"},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["profile_updated"],"affects":["user profile"],"depends_on":["user_id"]}
        },

        {
            name: 'SaveWorkspaceForm',
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form"],
            purpose: 'Save workspace settings',
            contextNeeded: ["workspace_name","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"workspace_name","selector":"input[name='workspaceName']","extraction_method":"value","data_type":"string","required":true,"description":"Workspace name"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["updated_settings"],"affects":["workspace settings"],"depends_on":["workspace_id"]}
        },

        {
            ...
            relationships: {"triggers":["preference_changed"],"affects":["notification settings"],"depends_on":["user_id"]}
        },

        {
            ...
            relationships: {"triggers":["upgrade_clicked"],"affects":["page navigation"],"depends_on":["current_plan"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project identifier"},{"field_name":"project_name","selector":"[data-project-id]","extraction_method":"textContent","data_type":"string","required":false,"description":"Project name"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["href attribute"]},
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-plan","required":true,"description":"Current subscription plan"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-cycle","required":false,"description":"Billing cycle"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
            relationships: {"triggers":["billing_management_clicked"],"affects":["modal/page state"],"depends_on":["workspace_id"]}
        },
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-15-et0geg45i4q] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-15-et0geg45i4q] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-10-15-et0geg45i4q] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-15-et0geg45i4q] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-15-et0geg45i4q] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-15-et0geg45i4q] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-15-et0geg45i4q] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
