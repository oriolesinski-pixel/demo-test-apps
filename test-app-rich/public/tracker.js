(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-05-1vskkyl78ej',
      ...
      this.componentDetectors = [
...

        {
            name: 'ErrorMessage',
            type: 'custom',
            selectors: [".bg-red-50.border.border-red-200.text-red-700.px-4.py-3.rounded"],
            purpose: 'Display error messages for login',
            contextNeeded: ["error"],
            contextCollection: {"search_parents":["form"],"extract_fields":["error"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-05-1vskkyl78ej');
