(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-05-kgln52n7hvs',
      ...
      this.componentDetectors = [
...

        {
            ...
            purpose: 'Cart management, wishlist, and other actions',
            contextNeeded: ["productId","quantity"],
            contextCollection: {"search_parents":[".product-card",".cart-item"],"extract_fields":["productId","quantity"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextNeeded: ["productId","quantity"],
            contextCollection: {"search_parents":[".cart-item"],"extract_fields":["productId","quantity"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'FormField',
            type: 'form_input',
            selectors: [".appearance-none.relative.block.w-full.px-3.py-2.border.border-gray-300.placeholder-gray-500.text-gray-900.rounded-md.focus:outline-none.focus:ring-blue-500.focus:border-blue-500.focus:z-10.sm:text-sm",".mt-1.appearance-none.relative.block.w-full.px-3.py-2.border.border-gray-300.placeholder-gray-500.text-gray-900.rounded-md.focus:outline-none.focus:ring-blue-500.focus:border-blue-500.focus:z-10.sm:text-sm"],
            purpose: 'Form input fields for login, register, and checkout',
            ...
            contextCollection: {"search_parents":["form"],"extract_fields":["email","password","name","confirmPassword","firstName","lastName","phone","address","city","state","zipCode","country","cardNumber","cardName","expiryDate","cvv"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'CheckoutForm',
            type: 'form',
            selectors: ["form.space-y-4","form.mt-8.space-y-6"],
            purpose: 'Checkout form submission',
            contextNeeded: ["firstName","lastName","email","phone","address","city","state","zipCode","country","cardNumber","cardName","expiryDate","cvv"],
...

        {
            ...
            purpose: 'Carousel for featured products',
...

        {
            ...
            purpose: 'Open/close login modal',
            contextNeeded: ["isAuthenticated","user"],
            contextCollection: {"search_parents":[".header"],"extract_fields":["isAuthenticated","user"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            purpose: 'Logout user',
            contextNeeded: ["user"],
            contextCollection: {"search_parents":[".header"],"extract_fields":["user"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-05-kgln52n7hvs');
