(function(root, factory) {
  ...
  console.log('[demo-test-apps-2025-11-03-q94z3zrt0hn] 🚀 Analytics tracker script loaded and executing...');
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-11-03-q94z3zrt0hn',
      ...
      this.componentDetectors = [
...

        {
            ...
            relationships: {"triggers":["dashboard_action"],"affects":["project_form_view"],"depends_on":["authenticated"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"User's current plan","field_purpose":"metadata"},{"field_name":"cta_location","selector":"button","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Where upgrade CTA clicked","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["workspace_data"]},
...

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["project_created"],"depends_on":["workspace_exists"]}
        },
...

        {
            ...
            relationships: {"triggers":["delete_click"],"affects":["task_deleted"],"depends_on":["task_exists"]}
        },

        {
            ...
            relationships: {"triggers":["archive_click"],"affects":["project_archived"],"depends_on":["project_exists"]}
        },

        {
            ...
            contextNeeded: ["invite_email","workspace_id","current_member_count"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Email to invite","field_purpose":"pii","anonymize":true},{"field_name":"current_member_count","selector":"body","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Existing team size","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["invite_submit"],"affects":["invitation_sent"],"depends_on":["workspace_exists"]}
        },

        {
            ...
            relationships: {"triggers":["remove_click"],"affects":["member_removed"],"depends_on":["member_exists"]}
        },

        {
            ...
            relationships: {"triggers":["settings_save"],"affects":["profile_updated"],"depends_on":["authenticated"]}
        },
...

        {
            ...
            relationships: {"triggers":["billing_click"],"affects":["billing_portal_view"],"depends_on":["premium_plan"]}
        },

        {
            ...
            relationships: {"triggers":["download_click"],"affects":["invoice_downloaded"],"depends_on":["invoice_exists"]}
        },
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project identifier","field_purpose":"metadata"},{"field_name":"task_count","selector":"[data-task-count]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-task-count","required":false,"description":"Number of tasks","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href"]},
            relationships: {"triggers":["project_click"],"affects":["project_detail_view"],"depends_on":["project_exists"]}
        },

        {
            ...
            purpose: 'View activity feed',
            contextNeeded: ["source_page"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Page navigated from","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["window.location"]},
            relationships: {"triggers":["nav_click"],"affects":["activity_page_view"],"depends_on":["authenticated"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-11-03-q94z3zrt0hn] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-11-03-q94z3zrt0hn] 📊 Tracking 21 discovered components');
      console.log('[demo-test-apps-2025-11-03-q94z3zrt0hn] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-11-03-q94z3zrt0hn] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-11-03-q94z3zrt0hn] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-11-03-q94z3zrt0hn] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    try {
      ...
      console.log('[demo-test-apps-2025-11-03-q94z3zrt0hn] ✅ AI-Enhanced Analytics tracker initialized successfully');
      console.log('[demo-test-apps-2025-11-03-q94z3zrt0hn] 📊 Tracking', window.analytics.componentDetectors?.length || 0, 'components');
    } catch (error) {
      console.error('[demo-test-apps-2025-11-03-q94z3zrt0hn] ❌ Analytics tracker initialization FAILED:', error);
      console.error('[demo-test-apps-2025-11-03-q94z3zrt0hn] Error details:', error.message, error.stack);
    }
  }
