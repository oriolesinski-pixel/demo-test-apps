(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-29-k7c0k95grv',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[value*='cardNumber']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[value*='expiry']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[value*='cvv']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name_completed","selector":"input[value*='cardholderName']","extraction_method":"value","data_type":"boolean","required":true,"description":"Cardholder name filled","field_purpose":"pii","anonymize":true},{"field_name":"billing_address_completed","selector":"input[value*='billingAddress']","extraction_method":"value","data_type":"boolean","required":false,"description":"Billing address filled","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["payment_form_submit"],"affects":["subscription_created"],"depends_on":["payment_validation"]}
        },
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_project_count","selector":"body","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Number of existing projects","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["dashboard_action"],"affects":["project_form_display"],"depends_on":["workspace_access"]}
        },
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"task_title","selector":"input[value*='taskTitle']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_description","selector":"textarea[value*='taskDescription']","extraction_method":"value","data_type":"string","required":false,"description":"Task description","field_purpose":"metadata"},{"field_name":"task_priority","selector":"select[value*='taskPriority']","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select[value*='taskAssignedTo']","extraction_method":"value","data_type":"string","required":false,"description":"Assigned team member","field_purpose":"metadata"},{"field_name":"due_date","selector":"input[value*='taskDueDate']","extraction_method":"value","data_type":"string","required":false,"description":"Task due date","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            selectors: ["select:has(option[value='todo'])","select:has(option[value='in_progress'])"],
...

        {
            ...
            selectors: ["button:has(svg.lucide-more-vertical)"],
            ...
            relationships: {"triggers":["button_click"],"affects":["menu_display"],"depends_on":["task_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button:has-text('Delete')","[role='menuitem']:has(svg.lucide-trash-2)"],
            purpose: 'Delete task',
            ...
            relationships: {"triggers":["menu_item_click"],"affects":["task_deleted"],"depends_on":["task_context"]}
        },

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["modal_open"],"depends_on":["workspace_context"]}
        },

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["invitation_sent"],"depends_on":["workspace_limits"]}
        },

        {
            ...
            relationships: {"triggers":["tab_click"],"affects":["content_display"],"depends_on":["settings_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["upgrade_intent"],"affects":["pricing_page_view"],"depends_on":["current_plan"]}
        },
...

        {
            ...
            selectors: ["button:has(svg.lucide-download)"],
            ...
            relationships: {"triggers":["button_click"],"affects":["file_download"],"depends_on":["invoice_context"]}
        },

        {
            ...
            relationships: {"triggers":["card_click"],"affects":["project_detail_view"],"depends_on":["project_context"]}
        },
...

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button:has(svg.lucide-arrow-left)","a:has(svg.lucide-arrow-left)"],
            purpose: 'Navigate back to previous page',
            contextNeeded: ["current_page","destination_page"],
            ...
            relationships: {"triggers":["button_click"],"affects":["page_navigation"],"depends_on":["navigation_history"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-29-k7c0k95grv] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-29-k7c0k95grv] 📊 Tracking 23 discovered components');
      console.log('[demo-test-apps-2025-10-29-k7c0k95grv] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-29-k7c0k95grv] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-29-k7c0k95grv] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-29-k7c0k95grv] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-29-k7c0k95grv] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
