(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-26-mxepem2f1te',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["focus"],"affects":["form_completion"],"depends_on":["checkout_step"]}
        },

        {
            ...
            type: 'input',
            pattern_type: 'form_field_focus',
            selectors: ["input[placeholder*='expiry']","input[placeholder*='MM/YY']"],
            purpose: 'Enter card expiry',
            contextNeeded: ["field_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"expiry_completed","selector":"input","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry field filled","field_purpose":"pci_protected","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["focus"],"affects":["form_completion"],"depends_on":["checkout_step"]}
        },

        {
            ...
            type: 'input',
            pattern_type: 'form_field_focus',
            selectors: ["input[placeholder*='CVV']","input[placeholder*='cvv']"],
            purpose: 'Enter CVV code',
            contextNeeded: ["field_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"cvv_completed","selector":"input","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV field filled","field_purpose":"pci_protected","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["focus"],"affects":["form_completion"],"depends_on":["checkout_step"]}
        },

        {
            ...
            purpose: 'Complete checkout purchase',
            contextNeeded: ["plan","cycle","amount","payment_fields"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan","field_purpose":"preference"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Billing frequency","field_purpose":"preference"},{"field_name":"total_amount","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Total purchase amount","field_purpose":"metadata"},{"field_name":"payment_fields_completed","selector":"form input","extraction_method":"count","data_type":"array","required":true,"description":"Completed payment fields","field_purpose":"metadata","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["form_validation"],"affects":["subscription_status"],"depends_on":["payment_info"]}
        },

        {
            ...
            relationships: {"triggers":["purchase_complete"],"affects":["dashboard_view"],"depends_on":["checkout_success"]}
        },

        {
            name: 'ProjectCreateButton',
            type: 'button',
            pattern_type: 'navigation',
            ...
            relationships: {"triggers":["button_click"],"affects":["project_form"],"depends_on":["plan_limits"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"project_name","selector":"input[name='name']","extraction_method":"value","data_type":"string","required":true,"description":"Project name","field_purpose":"metadata"},{"field_name":"project_description","selector":"textarea[name='description']","extraction_method":"value","data_type":"string","required":false,"description":"Project description","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["form_validation"],"affects":["project_list"],"depends_on":["workspace_limits"]}
        },

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["modal_state"],"depends_on":["project_context"]}
        },

        {
            ...
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"task_title","selector":"input","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_description","selector":"textarea","extraction_method":"value","data_type":"string","required":false,"description":"Task description","field_purpose":"metadata"},{"field_name":"task_priority","selector":"select","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select","extraction_method":"value","data_type":"string","required":false,"description":"Assigned user ID","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["form_validation"],"affects":["task_list"],"depends_on":["project_id"]}
        },

        {
            ...
            relationships: {"triggers":["dropdown_change"],"affects":["task_state"],"depends_on":["task_id"]}
        },
...

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["task_list"],"depends_on":["task_id"]}
        },

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["project_status"],"depends_on":["project_id"]}
        },
...

        {
            ...
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email address","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state"]},
            relationships: {"triggers":["form_validation"],"affects":["team_list"],"depends_on":["workspace_id"]}
        },

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["team_list"],"depends_on":["member_id"]}
        },

        {
            name: 'SettingsProfileSaveButton',
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button[type='submit']"],
            ...
            relationships: {"triggers":["form_validation"],"affects":["user_profile"],"depends_on":["user_id"]}
        },

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"label","fields":[{"field_name":"setting_name","selector":"label","extraction_method":"textContent","data_type":"string","required":true,"description":"Setting identifier","field_purpose":"preference"},{"field_name":"previous_state","selector":"input","extraction_method":"checked","data_type":"boolean","required":true,"description":"State before toggle","field_purpose":"preference"},{"field_name":"new_state","selector":"input","extraction_method":"checked","data_type":"boolean","required":true,"description":"State after toggle","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":["aria-checked"]},
            relationships: {"triggers":["toggle_click"],"affects":["user_preferences"],"depends_on":["user_id"]}
        },
        ...
        {
            name: 'DashboardNavLink',
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href^='/dashboard']"],
            purpose: 'Navigate dashboard sections',
            contextNeeded: ["destination","source"],
            context_collection: {"strategy":"global_context","scope_selector":"a","fields":[{"field_name":"destination","selector":"a","extraction_method":"data-attribute","data_type":"string","attribute_name":"href","required":true,"description":"Navigation destination","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href"]},
            relationships: {"triggers":["link_click"],"affects":["page_view"],"depends_on":["auth_state"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-26-mxepem2f1te] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-26-mxepem2f1te] 📊 Tracking 25 discovered components');
      console.log('[demo-test-apps-2025-10-26-mxepem2f1te] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-26-mxepem2f1te] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-26-mxepem2f1te] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-26-mxepem2f1te] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-26-mxepem2f1te] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
