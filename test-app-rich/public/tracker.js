(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-05-4mzd2hfwxy2',
      ...
      this.componentDetectors = [
        {
            ...
            contextCollection: {"search_parents":["form"],"extract_fields":["email","password","name","confirmPassword"],"code_patterns":["onClick={handleSubmit}","onClick={fillTestCredentials}"]}
        },

        {
            ...
            contextNeeded: ["route"],
            contextCollection: {"code_patterns":["href=\"/auth/register\"","href=\"/auth/login\"","href=\"/\"","href=\"/products\"","href=\"/wishlist\"","href=\"/cart\"","href=\"/checkout\"","href=\"/checkout/payment\"","href=\"/checkout/success\""]}
        },

        {
            ...
            contextCollection: {"search_parents":[".cart-item"],"extract_fields":["productId","quantity"]}
        },
...

        {
            ...
            purpose: 'Collect shipping information for the checkout process',
...

        {
            ...
            contextNeeded: ["productId","productName","productPrice","productImage"],
            contextCollection: {"search_parents":[".product-card"],"extract_fields":["productId","productName","productPrice","productImage"]}
        },

        {
            ...
            contextNeeded: ["productId"],
            contextCollection: {"search_parents":[".product-card"],"extract_fields":["productId"]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-05-4mzd2hfwxy2');
