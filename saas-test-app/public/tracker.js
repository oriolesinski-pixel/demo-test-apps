(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-25-4iz93c4y2fg',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"purchase_completed","selector":"body","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"Purchase success state","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["project_view"],"affects":["task_form_open"],"depends_on":["project_exists"]}
        },
...

        {
            ...
            relationships: {"triggers":["task_view"],"affects":["menu_open"],"depends_on":["task_exists"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label*='delete']","[role='menuitem']"],
            purpose: 'Delete task',
            ...
            relationships: {"triggers":["menu_item_click"],"affects":["task_deleted"],"depends_on":["task_exists"]}
        },

        {
            ...
            relationships: {"triggers":["team_page_view"],"affects":["invite_modal_open"],"depends_on":["workspace_exists"]}
        },

        {
            ...
            relationships: {"triggers":["invite_form_submit"],"affects":["invitation_sent"],"depends_on":["workspace_exists"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label*='remove']","[role='menuitem']"],
...

        {
            ...
            relationships: {"triggers":["profile_form_submit"],"affects":["profile_updated"],"depends_on":["user_authenticated"]}
        },
...

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"button[data-state='active']","extraction_method":"textContent","data_type":"string","required":true,"description":"Previous active tab","field_purpose":"metadata"},{"field_name":"new_tab","selector":"button[role='tab']","extraction_method":"textContent","data_type":"string","required":true,"description":"New active tab","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label*='download']"],
...

        {
            ...
            contextNeeded: ["project_id","source_page"],
...

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label*='archive']","[role='menuitem']"],
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-25-4iz93c4y2fg] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-25-4iz93c4y2fg] 📊 Tracking 23 discovered components');
      console.log('[demo-test-apps-2025-12-25-4iz93c4y2fg] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-25-4iz93c4y2fg] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-25-4iz93c4y2fg] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-25-4iz93c4y2fg] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-25-4iz93c4y2fg] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
