(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-25-niatrajot6',
      ...
      this.componentDetectors = [
        {
            ...
            contextNeeded: ["plan","billing_cycle","source_page"],
...

        {
            ...
            contextNeeded: ["step","plan","billing_cycle","amount"],
            context_collection: {"strategy":"component_props","scope_selector":"form","fields":[{"field_name":"current_step","selector":"[data-step]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-step","required":true,"description":"Current checkout step","field_purpose":"metadata"},{"field_name":"plan","selector":"input[name='plan']","extraction_method":"value","data_type":"string","required":true,"description":"Selected plan","field_purpose":"preference"},{"field_name":"billing_cycle","selector":"input[name='cycle']","extraction_method":"value","data_type":"string","required":true,"description":"Billing frequency","field_purpose":"preference"},{"field_name":"total_amount","selector":"[data-total]","extraction_method":"textContent","data_type":"number","required":true,"description":"Total checkout amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":["searchParams","localStorage"]},
            relationships: {"triggers":["checkout_started"],"affects":["payment_form_display"],"depends_on":["plan_selection"]}
        },

        {
            ...
            contextNeeded: ["card_fields_completed","billing_address_completed","plan","amount"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[name='cardNumber']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[name='expiry']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[name='cvv']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name","selector":"input[name='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card","field_purpose":"pii","anonymize":true},{"field_name":"billing_address_completed","selector":"input[name='billingAddress']","extraction_method":"value","data_type":"boolean","required":true,"description":"Billing address filled","field_purpose":"pii","anonymize":true},{"field_name":"plan","selector":"input[name='plan']","extraction_method":"value","data_type":"string","required":true,"description":"Selected plan","field_purpose":"preference"},{"field_name":"total_amount","selector":"[data-total]","extraction_method":"textContent","data_type":"number","required":true,"description":"Total payment amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["component_state"]},
            relationships: {"triggers":["checkout_step_2"],"affects":["subscription_created","success_page_redirect"],"depends_on":["payment_validation"]}
        },

        {
            ...
            contextNeeded: ["purchase_completed","plan","timestamp"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"purchase_completed","selector":"[data-success]","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"Purchase success status","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["localStorage"]},
            relationships: {"triggers":["purchase_success"],"affects":["dashboard_view"],"depends_on":["payment_processed"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href='/dashboard/projects/new']","button[onClick*='New Project']"],
...

        {
            ...
            relationships: {"triggers":["create_project_click"],"affects":["project_created","paywall_check"],"depends_on":["form_validation"]}
        },

        {
            ...
            contextNeeded: ["trigger_context","current_usage","limit","plan"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"trigger_context","selector":"[data-trigger]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-trigger","required":true,"description":"What triggered paywall","field_purpose":"metadata"},{"field_name":"current_usage","selector":"[data-current-count]","extraction_method":"textContent","data_type":"number","required":true,"description":"Current resource usage","field_purpose":"metadata"},{"field_name":"limit","selector":"[data-limit]","extraction_method":"textContent","data_type":"number","required":true,"description":"Plan limit reached","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["component_props"]},
...

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button[onClick*='upgrade']","a[href='/pricing']"],
            purpose: 'Navigate to pricing from paywall',
            contextNeeded: ["paywall_context","feature_blocked","current_plan"],
...

        {
            ...
            relationships: {"triggers":["task_view"],"affects":["task_updated","activity_logged"],"depends_on":["task_access"]}
        },
...

        {
            ...
            selectors: ["button[onClick*='delete']","[data-action='delete']"],
            purpose: 'Delete task',
            ...
            relationships: {"triggers":["task_menu_open"],"affects":["task_deleted"],"depends_on":["task_access"]}
        },

        {
            ...
            relationships: {"triggers":["project_menu_open"],"affects":["project_archived"],"depends_on":["project_access"]}
        },
...

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form[onSubmit*='handleInvite']"],
            purpose: 'Send team invitation',
            contextNeeded: ["invite_email","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[name='email']","extraction_method":"value","data_type":"string","required":true,"description":"Email to invite","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["component_state"]},
            relationships: {"triggers":["invite_button_click"],"affects":["invitation_sent"],"depends_on":["email_validation"]}
        },
...

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button[onClick*='manage']","a[href*='billing']"],
            purpose: 'Navigate to billing management',
            contextNeeded: ["current_plan","billing_cycle"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"[data-plan]","extraction_method":"textContent","data_type":"string","required":true,"description":"Active subscription plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["api_call"]},
            relationships: {"triggers":["settings_view"],"affects":["billing_page_view"],"depends_on":["subscription_active"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href='/pricing']","button[onClick*='upgrade']"],
            purpose: 'Navigate to pricing page',
            contextNeeded: ["source_page","current_plan","trigger_context"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-page","required":true,"description":"Page where upgrade clicked","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["window.location"]},
            relationships: {"triggers":["dashboard_view","limit_reached"],"affects":["pricing_page_view"],"depends_on":["free_plan_active"]}
        },

        {
            ...
            relationships: {"triggers":["projects_page_view"],"affects":["project_detail_view"],"depends_on":["project_access"]}
        },

        {
            ...
            type: 'link',
            pattern_type: 'item_selection',
            selectors: ["[data-activity-item]"],
            purpose: 'View activity detail',
            contextNeeded: ["activity_type","entity_id","user_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-activity-item]","fields":[{"field_name":"activity_type","selector":"[data-activity-type]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-activity-type","required":true,"description":"Type of activity","field_purpose":"metadata"},{"field_name":"entity_id","selector":"[data-entity-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-entity-id","required":true,"description":"Related entity","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["component_props"]},
            relationships: {"triggers":["activity_page_view"],"affects":["entity_view"],"depends_on":["activity_access"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-25-niatrajot6] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-25-niatrajot6] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-12-25-niatrajot6] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-25-niatrajot6] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-25-niatrajot6] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-25-niatrajot6] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-25-niatrajot6] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
