(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-06-yz9g7xd46fr',
      ...
      this.componentDetectors = [
...

        {
            ...
            purpose: 'Navigate to products page',
            contextNeeded: undefined,
            contextCollection: {"search_parents":[],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            type: 'link',
            selectors: [".text-gray-700.hover:text-blue-600.transition-colors"],
            purpose: 'Navigate to about page',
            contextNeeded: undefined,
            contextCollection: {"search_parents":[],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            type: 'link',
            selectors: [".text-gray-700.hover:text-blue-600.transition-colors"],
            purpose: 'Navigate to shipping page',
            contextNeeded: undefined,
            contextCollection: {"search_parents":[],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            type: 'link',
            selectors: [".text-gray-700.hover:text-blue-600.transition-colors"],
            purpose: 'Navigate to returns page',
            contextNeeded: undefined,
            contextCollection: {"search_parents":[],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextCollection: {"search_parents":[],"extract_fields":["item_count"],"sibling_context":[],"data_attributes":[]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-06-yz9g7xd46fr');
