(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-05-ub79znonek',
      ...
      this.componentDetectors = [
...

        {
            ...
            purpose: 'Navigate to registration, login, or checkout pages',
            contextNeeded: [],
...

        {
            ...
            purpose: 'Display a carousel of featured products',
...

        {
            ...
            contextNeeded: ["productId"],
            contextCollection: {"search_parents":[".product-card"],"extract_fields":["productId"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-05-ub79znonek');
