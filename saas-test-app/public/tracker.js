(function(root, factory) {
  ...
  console.log('[demo-test-apps-2025-11-12-had5wytco24] 🚀 Analytics tracker script loaded and executing...');
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-11-12-had5wytco24',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name","selector":"input","extraction_method":"value","data_type":"string","required":true,"description":"Name on card","field_purpose":"pii","anonymize":true},{"field_name":"billing_address_completed","selector":"input","extraction_method":"value","data_type":"boolean","required":true,"description":"Address fields filled","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["payment_button_click"],"affects":["subscription_created"],"depends_on":["checkout_step_2"]}
        },

        {
            ...
            contextNeeded: ["plan","purchase_complete"],
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace","field_purpose":"metadata"},{"field_name":"project_count","selector":".card","extraction_method":"count","data_type":"number","required":false,"description":"Existing project count","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["project_created"],"depends_on":["workspace_access"]}
        },
...

        {
            ...
            relationships: {"triggers":["dropdown_change"],"affects":["task_updated"],"depends_on":["task_context"]}
        },

        {
            ...
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["invite_button"],"affects":["invitation_sent"],"depends_on":["workspace_access"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["save_button"],"affects":["profile_updated"],"depends_on":["user_authenticated"]}
        },

        {
            ...
            relationships: {"triggers":["toggle_click"],"affects":["preference_updated"],"depends_on":["user_authenticated"]}
        },

        {
            ...
            relationships: {"triggers":["upgrade_intent"],"affects":["pricing_page_view"],"depends_on":["free_plan"]}
        },

        {
            ...
            selectors: ["a[href*='/dashboard/projects/']",".card"],
            purpose: 'View project details',
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":".card","fields":[{"field_name":"project_id","selector":"a","extraction_method":"data-attribute","data_type":"string","attribute_name":"href","required":true,"description":"Project identifier","field_purpose":"metadata"},{"field_name":"project_name","selector":".card-title","extraction_method":"textContent","data_type":"string","required":true,"description":"Project name","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["card_click"],"affects":["project_detail_view"],"depends_on":["project_exists"]}
        },

        {
            name: 'TaskActionDropdown',
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-haspopup='menu']","button"],
            purpose: 'Open task actions menu',
            contextNeeded: ["task_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["dropdown_click"],"affects":["menu_displayed"],"depends_on":["task_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["remove_click"],"affects":["member_removed"],"depends_on":["workspace_context"]}
        },
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-11-12-had5wytco24] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-11-12-had5wytco24] 📊 Tracking 19 discovered components');
      console.log('[demo-test-apps-2025-11-12-had5wytco24] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-11-12-had5wytco24] 📍 Session ID:', this.sessionId);
    ...
    trackAllClicks() {
      document.addEventListener('click', (e) => {
        ...
        if (clickable || componentInfo) {
          ...
          // Check if this is a toggle/switch element
          const isToggle = this.isToggleElement(element);
          ...
          // For toggles, capture state change
          if (isToggle) {
            const input = element.querySelector('input[type="checkbox"]') || element;
            if (input && input.type === 'checkbox') {
              contextData.previous_state = !input.checked;
              contextData.new_state = input.checked;
              contextData.toggle_name = input.name || input.id || this.getElementText(element);
            }
          }
          ...
          const eventData = {
            ...
            element_type: isToggle ? 'toggle' : this.getButtonType(element),
            surface: this.getSurface(element),
            page_path: window.location.pathname,
            pattern_type: isToggle ? 'toggle_state' : (componentInfo?.pattern_type || null)
          };
          ...
          if (contextData && Object.keys(contextData).length > 0) {
            ...
            if (Object.keys(cleanContext).length > 0) {
              eventData.context = cleanContext;
            }
          }
    ...
    trackFormInteractions() {
      ...
      document.addEventListener('submit', (e) => {
        ...
        // Add form data as context if available
        if (Object.keys(cleanContext).length > 0) {
          eventData.context = cleanContext;
        }
          ...
          if (mutation.type === 'attributes' && 
            ...
            if (isOverlay) {
              ...
              if (isVisible && !wasVisible) {
                ...
                // Always use MODAL_INTERACTION for dialogs
                const componentInfo = this.detectComponent(element);
                let context = componentInfo ? this.extractContext(element, componentInfo) : {};
                
                // Extract form data if modal contains a form
                const modalForm = element.querySelector('form');
                if (modalForm) {
                  const formData = this.getFormFieldValues(modalForm);
    ...
    getButtonType(element) {
      ...
      if (element.getAttribute('role') === 'switch') return 'toggle';
      return 'button';
    }
    ...
    isToggleElement(element) {
      ...
      return role === 'switch' ||
             ...
             (element.querySelector && element.querySelector('input[type="checkbox"]') !== null) ||
             ariaChecked !== null;
    }
    
    // Generate meaningful component name when AI detection fails
    generateComponentName(element) {
      // Special case: Hamburger/mobile menu
      const ariaLabel = element.getAttribute('aria-label')?.toLowerCase() || '';
      if (ariaLabel.includes('menu') && element.tagName === 'BUTTON') {
    ...
    getOverlayType(element) {
      ...
      // Prioritize dialog/modal detection
      if (role === 'dialog' || ariaModal === 'true') return 'modal';
      ...
      return 'modal'; // Default to modal for safety
    }
    ...
    isOverlayElement(element) {
      ...
      // Only track dialogs and modals (not tooltips/dropdowns - too noisy)
      return role === 'dialog' ||
             ariaModal === 'true' ||
             classes.includes('modal') ||
             (classes.includes('dialog') && !classes.includes('dropdown'));
    }
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-11-12-had5wytco24] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-11-12-had5wytco24] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    try {
      ...
      console.log('[demo-test-apps-2025-11-12-had5wytco24] ✅ AI-Enhanced Analytics tracker initialized successfully');
      console.log('[demo-test-apps-2025-11-12-had5wytco24] 📊 Tracking', window.analytics.componentDetectors?.length || 0, 'components');
    } catch (error) {
      console.error('[demo-test-apps-2025-11-12-had5wytco24] ❌ Analytics tracker initialization FAILED:', error);
      console.error('[demo-test-apps-2025-11-12-had5wytco24] Error details:', error.message, error.stack);
    }
  }
