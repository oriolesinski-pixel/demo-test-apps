(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-06-g8d84knkk2j',
      ...
      this.componentDetectors = [
        {
            name: 'LoginButton',
            type: 'button',
            selectors: [".inline-block.bg-blue-600.text-white.px-6.py-3.rounded-lg.hover:bg-blue-700"],
...

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":["nav","footer"]}
        },
...

        {
            ...
            type: 'button',
            selectors: [".text-sm.text-gray-600"],
...

        {
            ...
            type: 'form_input',
            selectors: ["#email",".mt-1.appearance-none.relative.block.w-full.px-3.py-2.border.border-gray-300.placeholder-gray-500.text-gray-900.rounded-md.focus:outline-none.focus:ring-blue-500.focus:border-blue-500.focus:z-10.sm:text-sm"],
            purpose: 'Email input for registration',
            contextNeeded: ["email"],
            contextCollection: {"search_parents":["form"],"extract_fields":["email"]}
        },

        {
            ...
            type: 'form_input',
            selectors: ["#password",".mt-1.appearance-none.relative.block.w-full.px-3.py-2.border.border-gray-300.placeholder-gray-500.text-gray-900.rounded-md.focus:outline-none.focus:ring-blue-500.focus:border-blue-500.focus:z-10.sm:text-sm"],
            purpose: 'Password input for registration',
            contextNeeded: ["password"],
            contextCollection: {"search_parents":["form"],"extract_fields":["password"]}
        },

        {
            name: 'RegisterConfirmPasswordInput',
            type: 'form_input',
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-06-g8d84knkk2j');
