(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-10-qavqurclsl',
      ...
      this.pageContext = {};
      this.previousPath = null;  // Track previous path for SPA navigation
      ...
      this.componentDetectors = [
...

        {
            ...
            selectors: ["input[value*='cardNumber']","input[placeholder*='card']"],
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan","field_purpose":"preference"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Billing cycle","field_purpose":"preference"},{"field_name":"total_amount","selector":"[data-total]","extraction_method":"textContent","data_type":"number","required":true,"description":"Total amount","field_purpose":"metadata"},{"field_name":"payment_fields_completed","selector":"form input","extraction_method":"count","data_type":"array","required":true,"description":"Completed payment fields","field_purpose":"metadata","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["payment_info_entered"],"affects":["subscription_created"],"depends_on":["payment_validation"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"upgrade_success","selector":"body","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"Upgrade completed successfully","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["dashboard_view"],"affects":["project_form_display"],"depends_on":["user_authenticated"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button[type='submit']","form button:has-text('Create')"],
            purpose: 'Submit new project form',
            ...
            relationships: {"triggers":["form_filled"],"affects":["project_created"],"depends_on":["validation_passed"]}
        },

        {
            ...
            relationships: {"triggers":["project_view"],"affects":["task_modal_display"],"depends_on":["project_loaded"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button[type='submit']","form button:has-text('Create Task')"],
            purpose: 'Create new task',
            contextNeeded: ["task_title","description","priority","assigned_to","project_id"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"task_title","selector":"input[value*='taskTitle']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_priority","selector":"select[value*='taskPriority']","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select[value*='taskAssignedTo']","extraction_method":"value","data_type":"string","required":false,"description":"Assigned user ID","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["task_form_filled"],"affects":["task_created"],"depends_on":["project_id"]}
        },

        {
            ...
            selectors: ["select[value*='status']","[role='combobox']"],
            ...
            relationships: {"triggers":["task_view"],"affects":["task_updated"],"depends_on":["task_loaded"]}
        },

        {
            ...
            relationships: {"triggers":["team_page_view"],"affects":["invite_modal_display"],"depends_on":["workspace_loaded"]}
        },

        {
            name: 'InviteFormSubmit',
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button[onClick*='handleInvite']","form button:has-text('Invite')"],
            purpose: 'Send team invitation',
            contextNeeded: ["invite_email","workspace_id"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"invite_email","selector":"input[value*='inviteEmail']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email address","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["invite_form_filled"],"affects":["invitation_sent"],"depends_on":["email_validation"]}
        },

        {
            name: 'SettingsProfileSave',
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button[onClick*='handleSaveProfile']"],
...

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"[data-setting]","fields":[{"field_name":"setting_name","selector":"[data-setting]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-setting","required":true,"description":"Setting identifier","field_purpose":"preference"},{"field_name":"enabled","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"Toggle state","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["paywall_encountered"],"affects":["pricing_page_view"],"depends_on":["free_plan"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"a[href*='/projects/']","extraction_method":"data-attribute","data_type":"string","attribute_name":"href","required":true,"description":"Project identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["projects_page_view"],"affects":["project_detail_view"],"depends_on":["project_exists"]}
        },

        {
            ...
            relationships: {"triggers":["task_view"],"affects":["edit_modal_display"],"depends_on":["task_loaded"]}
        },

        {
            ...
            relationships: {"triggers":["task_menu_open"],"affects":["task_deleted"],"depends_on":["task_id"]}
        },

        {
            ...
            relationships: {"triggers":["project_menu_open"],"affects":["project_archived"],"depends_on":["project_id"]}
        },

        {
            ...
            relationships: {"triggers":["settings_view"],"affects":["billing_page_view"],"depends_on":["user_authenticated"]}
        },

        {
            ...
            relationships: {"triggers":["settings_view"],"affects":["tab_content_display"],"depends_on":["tabs_loaded"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-10-qavqurclsl] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-10-qavqurclsl] 📊 Tracking 23 discovered components');
      console.log('[demo-test-apps-2025-12-10-qavqurclsl] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-10-qavqurclsl] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-10-qavqurclsl] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-10-qavqurclsl] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-10-qavqurclsl] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
