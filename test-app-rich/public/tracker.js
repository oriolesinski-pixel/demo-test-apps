(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-06-0hisf3jne1hu',
      ...
      this.componentDetectors = [
        {
            name: 'Button',
            type: 'button',
            selectors: [".inline-block.bg-blue-600.text-white.px-6.py-3.rounded-lg.hover:bg-blue-700",".text-red-500.hover:text-red-700",".p-1.hover:bg-gray-100.rounded",".text-sm.text-gray-700.hover:text-blue-600"],
            purpose: 'Continue shopping,Remove item from cart,Increase/decrease quantity,Logout',
            contextNeeded: ["product_id","quantity"],
            contextCollection: {"search_parents":[".product-card","[data-product]","form"],"extract_fields":["product-id","quantity"],"sibling_context":["input[name='size']",".color-selector.active"],"data_attributes":["data-product-id","data-sku"]}
        },

        {
            name: 'Link',
            type: 'link',
            selectors: [".font-medium.text-blue-600.hover:text-blue-500",".inline-block.bg-blue-600.text-white.px-6.py-3.rounded-lg.hover:bg-blue-700",".text-gray-700.hover:text-blue-600"],
            purpose: 'Navigate to register page,Navigate to checkout page,Navigate to product, about, shipping, returns pages',
            contextNeeded: null,
...

        {
            name: 'IconButton',
            type: 'icon',
            selectors: [".relative.text-gray-700.hover:text-blue-600",".text-red-500.hover:text-red-700"],
            purpose: 'Open wishlist,Open cart,Remove item from cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["product-id"],"sibling_context":null,"data_attributes":["data-product-id"]}
        },

        {
            ...
            contextNeeded: ["product_id","quantity"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["product-id","quantity"],"sibling_context":null,"data_attributes":["data-product-id"]}
        },

        {
            name: 'LoginForm',
            type: 'form',
            selectors: [".mt-8.space-y-6",".rounded-md.shadow-sm.-space-y-px"],
            purpose: 'User authentication',
            contextNeeded: ["email","password"],
            contextCollection: {"search_parents":null,"extract_fields":["email","password"],"sibling_context":null,"data_attributes":null}
        },

        {
            ...
            contextCollection: {"search_parents":null,"extract_fields":["name","email","password","confirmPassword"],"sibling_context":null,"data_attributes":null}
        },

        {
            ...
            type: 'form',
            selectors: [".space-y-4"],
            purpose: 'Shipping information collection',
            contextNeeded: ["firstName","lastName","email","phone","address","city","state","zipCode","country"],
            contextCollection: {"search_parents":null,"extract_fields":["firstName","lastName","email","phone","address","city","state","zipCode","country"],"sibling_context":null,"data_attributes":null}
        },

        {
            ...
            contextCollection: {"search_parents":null,"extract_fields":["cardNumber","cardName","expiryDate","cvv","saveCard"],"sibling_context":null,"data_attributes":null}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-06-0hisf3jne1hu');
