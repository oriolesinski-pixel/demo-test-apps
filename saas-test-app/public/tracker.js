(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2026-02-26-2xxklv0h21j',
      ...
      this.componentDetectors = [
        {
            ...
            relationships: {"triggers":["click"],"affects":["step_state","checkout_progress"],"depends_on":["plan_selection","billing_cycle"]},
...

        {
            ...
            contextNeeded: ["plan","billing_cycle","amount","tax","total","payment_fields_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"payment_fields_completed","selector":"input","extraction_method":"count","data_type":"array","required":true,"description":"List of completed payment fields","field_purpose":"pci_protected","anonymize":true},{"field_name":"plan","selector":"searchParams","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan"},{"field_name":"billing_cycle","selector":"searchParams","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Billing frequency"},{"field_name":"total_amount","selector":"state","extraction_method":"value","data_type":"number","required":true,"description":"Total checkout amount"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["form_submit"],"affects":["subscription_status","workspace_plan"],"depends_on":["plan_selection","payment_info"]},
            // Form collection detection - for buttons that submit forms
...

        {
            ...
            selectors: ["a[href='/dashboard']",".dashboard-link"],
            purpose: 'Navigate to dashboard after success',
            contextNeeded: ["conversion_completed","plan_upgraded"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"conversion_completed","selector":"page","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"User completed checkout"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["click"],"affects":["page_navigation"],"depends_on":["checkout_completion"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },
...

        {
            ...
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"project_id","selector":"params","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project ID"},{"field_name":"task_title","selector":"input","extraction_method":"value","data_type":"string","required":true,"description":"Task title"},{"field_name":"priority","selector":"select","extraction_method":"value","data_type":"string","required":false,"description":"Task priority level"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true}},
            relationships: {"triggers":["modal_submit"],"affects":["task_list","project_tasks"],"depends_on":["project_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
            form_schema: {"form_name":"CreateTaskForm","form_selector":"form","fields":[{"field_name":"taskTitle","field_label":"Task Title","field_type":"text","required":true,"is_sensitive":false},{"field_name":"taskDescription","field_label":"Description","field_type":"textarea","required":false,"is_sensitive":false},{"field_name":"taskPriority","field_label":"Priority","field_type":"select","required":false,"is_sensitive":false},{"field_name":"taskAssignedTo","field_label":"Assigned To","field_type":"select","required":false,"is_sensitive":false},{"field_name":"taskDueDate","field_label":"Due Date","field_type":"date","required":false,"is_sensitive":false}],"submit_button_selector":"button[type='submit']"}
        },

        {
            ...
            selectors: ["select",".status-select"],
            ...
            relationships: {"triggers":["select_change"],"affects":["task_status","activity_log"],"depends_on":["task_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Email of invitee","field_purpose":"pii","anonymize":true},{"field_name":"workspace_id","selector":"state","extraction_method":"value","data_type":"string","required":true,"description":"Target workspace"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["modal_submit"],"affects":["invitations_list","team_members"],"depends_on":["workspace_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
            form_schema: {"form_name":"InviteTeamMemberForm","form_selector":"form","fields":[{"field_name":"inviteEmail","field_label":"Email Address","field_type":"email","required":true,"is_sensitive":false}],"submit_button_selector":"button[type='submit']"}
        },

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["user_profile"],"depends_on":["user_authentication"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: true,
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"workspace","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current subscription plan"},{"field_name":"source_page","selector":"window.location","extraction_method":"value","data_type":"string","required":true,"description":"Page where upgrade clicked"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["click"],"affects":["page_navigation"],"depends_on":["workspace_plan"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":".project-card","fields":[{"field_name":"project_id","selector":"a","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project identifier"},{"field_name":"project_name","selector":".project-title","extraction_method":"textContent","data_type":"string","required":true,"description":"Project name"},{"field_name":"task_count","selector":".task-count","extraction_method":"textContent","data_type":"number","required":false,"description":"Number of tasks"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["click"],"affects":["page_navigation"],"depends_on":["project_list"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button",".delete-task-btn"],
            purpose: 'Delete task',
            contextNeeded: ["task_id","task_title","project_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to delete"},{"field_name":"project_id","selector":"params","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Parent project"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["click"],"affects":["task_list","activity_log"],"depends_on":["task_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button",".archive-project-btn"],
            purpose: 'Archive project',
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"params","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project to archive"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["click"],"affects":["project_status","activity_log"],"depends_on":["project_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href='/dashboard/settings/billing']",".billing-link"],
            purpose: 'Navigate to billing settings',
            contextNeeded: ["current_plan","billing_cycle"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"workspace","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current plan"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["click"],"affects":["page_navigation"],"depends_on":["workspace_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button",".download-invoice-btn"],
            purpose: 'Download invoice PDF',
            contextNeeded: ["invoice_id","invoice_date","amount"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-invoice-id]","fields":[{"field_name":"invoice_id","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-invoice-id","required":true,"description":"Invoice identifier"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false}},
            relationships: {"triggers":["click"],"affects":["file_download"],"depends_on":["invoice_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button",".remove-member-btn"],
            ...
            relationships: {"triggers":["click"],"affects":["team_members","activity_log"],"depends_on":["member_context"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        },

        {
            ...
            selectors: ["button[role='tab']",".tab-trigger"],
            ...
            relationships: {"triggers":["click"],"affects":["active_tab"],"depends_on":["tab_state"]},
            // Form collection detection - for buttons that submit forms
            is_form_collection: false,
            form_schema: null
        }
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2026-02-26-2xxklv0h21j] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2026-02-26-2xxklv0h21j] 📊 Tracking 17 discovered components');
      console.log('[demo-test-apps-2026-02-26-2xxklv0h21j] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2026-02-26-2xxklv0h21j] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2026-02-26-2xxklv0h21j] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2026-02-26-2xxklv0h21j] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2026-02-26-2xxklv0h21j] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
