(function(root, factory) {
  ...
  // Confirm tracker script is executing
  console.log('[demo-test-apps-2025-11-02-nld7saffqfk] 🚀 Analytics tracker script loaded and executing...');
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-11-02-nld7saffqfk',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextNeeded: ["current_step","plan","cycle"],
            context_collection: {"strategy":"component_props","scope_selector":"body","fields":[{"field_name":"current_step","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Step user is leaving","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["checkout_abandoned"],"affects":["pricing_page_view"],"depends_on":["checkout_started"]}
        },

        {
            name: 'CheckoutSuccessContinue',
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button"],
            purpose: 'Navigate to dashboard after upgrade',
            contextNeeded: ["plan","upgrade_completed"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"upgrade_completed","selector":"body","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"Upgrade success confirmed","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["success_page_exit"],"affects":["dashboard_view"],"depends_on":["upgrade_completed"]}
        },

        {
            ...
            relationships: {"triggers":["upgrade_intent"],"affects":["pricing_page_view"],"depends_on":["dashboard_view"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button","a[href*='/projects/new']"],
            purpose: 'Navigate to project creation',
            contextNeeded: ["project_count","plan"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_project_count","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Number of existing projects","field_purpose":"metadata"},{"field_name":"workspace_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["project_creation_intent"],"affects":["project_form_view"],"depends_on":["dashboard_view"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"project_name","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"Project name","field_purpose":"metadata"},{"field_name":"project_description","selector":"textarea","extraction_method":"value","data_type":"string","required":false,"description":"Project description","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["project_created"],"affects":["project_list_updated"],"depends_on":["new_project_clicked"]}
        },

        {
            ...
            contextNeeded: ["context","current_usage","limit"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"paywall_context","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Why paywall shown","field_purpose":"metadata"},{"field_name":"current_usage","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Current resource usage","field_purpose":"metadata"},{"field_name":"usage_limit","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Plan limit reached","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["limit_reached"],"affects":["upgrade_decision"],"depends_on":["resource_creation_attempt"]}
        },

        {
            ...
            contextNeeded: ["paywall_context","current_usage"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"paywall_context","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Paywall trigger context","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["paywall_upgrade_clicked"],"affects":["pricing_page_view"],"depends_on":["paywall_shown"]}
        },

        {
            ...
            relationships: {"triggers":["project_selected"],"affects":["project_detail_view"],"depends_on":["project_list_view"]}
        },

        {
            ...
            relationships: {"triggers":["task_modal_open"],"affects":["task_form_display"],"depends_on":["project_view"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"task_title","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_description","selector":"textarea","extraction_method":"value","data_type":"string","required":false,"description":"Task description","field_purpose":"metadata"},{"field_name":"task_priority","selector":"select","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select","extraction_method":"value","data_type":"string","required":false,"description":"Assigned team member","field_purpose":"metadata"},{"field_name":"due_date","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":false,"description":"Task due date","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["task_created"],"affects":["task_list_updated"],"depends_on":["create_task_clicked"]}
        },

        {
            ...
            relationships: {"triggers":["status_changed"],"affects":["task_updated"],"depends_on":["task_view"]}
        },

        {
            ...
            relationships: {"triggers":["menu_opened"],"affects":["menu_display"],"depends_on":["task_view"]}
        },

        {
            ...
            relationships: {"triggers":["task_deleted"],"affects":["task_list_updated"],"depends_on":["task_menu_opened"]}
        },

        {
            ...
            contextNeeded: ["project_id"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"project_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project to edit","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["url_params"]},
            relationships: {"triggers":["edit_modal_opened"],"affects":["edit_form_display"],"depends_on":["project_view"]}
        },

        {
            ...
            relationships: {"triggers":["project_archived"],"affects":["project_list_updated"],"depends_on":["project_menu_opened"]}
        },

        {
            ...
            relationships: {"triggers":["profile_updated"],"affects":["user_data_changed"],"depends_on":["settings_view"]}
        },
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace identifier","field_purpose":"metadata"},{"field_name":"current_member_count","selector":"body","extraction_method":"count","data_type":"number","required":true,"description":"Current team size","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["invite_modal_opened"],"affects":["invite_form_display"],"depends_on":["team_view"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["invitation_sent"],"affects":["team_list_updated"],"depends_on":["invite_button_clicked"]}
        },

        {
            ...
            relationships: {"triggers":["member_removed"],"affects":["team_list_updated"],"depends_on":["team_view"]}
        },

        {
            ...
            contextNeeded: ["plan","billing_cycle"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current subscription plan","field_purpose":"metadata"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Billing frequency","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["billing_management_opened"],"affects":["billing_portal_view"],"depends_on":["billing_page_view"]}
        },

        {
            ...
            relationships: {"triggers":["invoice_downloaded"],"affects":["file_download"],"depends_on":["billing_page_view"]}
        },

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"button[role='tab'][aria-selected='true']","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Tab before switch","field_purpose":"metadata"},{"field_name":"new_tab","selector":"button[role='tab']","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Tab after switch","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["tab_changed"],"affects":["tab_content_display"],"depends_on":["settings_view"]}
        },
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-11-02-nld7saffqfk] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-11-02-nld7saffqfk] 📊 Tracking 27 discovered components');
      console.log('[demo-test-apps-2025-11-02-nld7saffqfk] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-11-02-nld7saffqfk] 📍 Session ID:', this.sessionId);
    ...
    trackEvent(eventType, data = {}) {
      ...
      const event = {
        ...
        ts: Date.now(),                          // Unix timestamp in milliseconds, never null
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-11-02-nld7saffqfk] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-11-02-nld7saffqfk] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    try {
      ...
      console.log('[demo-test-apps-2025-11-02-nld7saffqfk] ✅ AI-Enhanced Analytics tracker initialized successfully');
      console.log('[demo-test-apps-2025-11-02-nld7saffqfk] 📊 Tracking', window.analytics.componentDetectors?.length || 0, 'components');
    } catch (error) {
      console.error('[demo-test-apps-2025-11-02-nld7saffqfk] ❌ Analytics tracker initialization FAILED:', error);
      console.error('[demo-test-apps-2025-11-02-nld7saffqfk] Error details:', error.message, error.stack);
    }
  }
