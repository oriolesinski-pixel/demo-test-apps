(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-15-49qln7ze3jx',
      ...
      this.componentDetectors = [
        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"plan","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-plan","required":true,"description":"Selected subscription plan"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-cycle","required":true,"description":"Monthly or annual billing"},{"field_name":"step","selector":"body","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-step","required":true,"description":"Current checkout step"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":["URL searchParams"]},
            relationships: {"triggers":["checkout_step_viewed"],"affects":["step state"],"depends_on":["plan selection"]}
        },

        {
            name: 'CheckoutCompleteForm',
            type: 'form',
            pattern_type: 'form_submission,multi_step_flow',
            selectors: ["form"],
            purpose: 'Complete checkout with payment',
            contextNeeded: ["card_number","expiry","cvv","cardholder_name","billing_address","city","state","zip","plan","billing_cycle","total"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number","selector":"input[name='cardNumber']","extraction_method":"value","data_type":"string","required":true,"description":"Credit card number"},{"field_name":"expiry","selector":"input[name='expiry']","extraction_method":"value","data_type":"string","required":true,"description":"Card expiration date"},{"field_name":"cvv","selector":"input[name='cvv']","extraction_method":"value","data_type":"string","required":true,"description":"Card CVV code"},{"field_name":"cardholder_name","selector":"input[name='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card"},{"field_name":"billing_address","selector":"input[name='billingAddress']","extraction_method":"value","data_type":"string","required":true,"description":"Billing street address"},{"field_name":"city","selector":"input[name='city']","extraction_method":"value","data_type":"string","required":true,"description":"Billing city"},{"field_name":"state","selector":"input[name='state']","extraction_method":"value","data_type":"string","required":true,"description":"Billing state"},{"field_name":"zip","selector":"input[name='zip']","extraction_method":"value","data_type":"string","required":true,"description":"Billing ZIP code"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"upgrade_completed","selector":"body","extraction_method":"data-attribute","data_type":"boolean","attribute_name":"data-upgrade-complete","required":true,"description":"Upgrade completion status"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["URL path"]},
            relationships: {"triggers":["dashboard_navigation"],"affects":["page navigation"],"depends_on":["checkout completion"]}
        },
...

        {
            ...
            contextNeeded: ["project_id","modal_opened"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Parent project ID"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["URL params"]},
            relationships: {"triggers":["modal_opened"],"affects":["dialog visibility"],"depends_on":["project context"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"title","selector":"input[name='title']","extraction_method":"value","data_type":"string","required":true,"description":"Task title"},{"field_name":"description","selector":"textarea[name='description']","extraction_method":"value","data_type":"string","required":false,"description":"Task description"},{"field_name":"priority","selector":"select[name='priority']","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level"},{"field_name":"assigned_to","selector":"select[name='assignedTo']","extraction_method":"value","data_type":"string","required":false,"description":"Assigned team member ID"},{"field_name":"due_date","selector":"input[type='date']","extraction_method":"value","data_type":"string","required":false,"description":"Task due date"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
            relationships: {"triggers":["created_task"],"affects":["task list"],"depends_on":["project_id"]}
        },
...

        {
            ...
            selectors: ["button[aria-label='Task actions']"],
            purpose: 'Open task actions dropdown',
            ...
            relationships: {"triggers":["dropdown_opened"],"affects":["menu visibility"],"depends_on":["task context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-action='delete']"],
            purpose: 'Delete task',
            contextNeeded: ["task_id","task_title","project_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to delete"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["menu context"]},
            relationships: {"triggers":["task_deleted"],"affects":["task list"],"depends_on":["task_id"]}
        },

        {
            name: 'EditProjectDialog',
            type: 'button',
            pattern_type: 'modal_lifecycle,inline_edit',
            selectors: ["button[data-action='edit-project']"],
            purpose: 'Open edit project modal',
            contextNeeded: ["project_id","project_name","project_description"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project identifier"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":["URL params"]},
            relationships: {"triggers":["edit_modal_opened"],"affects":["modal visibility"],"depends_on":["project context"]}
        },

        {
            name: 'ArchiveProjectAction',
            type: 'button',
            pattern_type: 'item_selection,toggle_state',
            selectors: ["button[data-action='archive']"],
            purpose: 'Archive project',
            contextNeeded: ["project_id","project_name","previous_status"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project to archive"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":["dropdown context"]},
            relationships: {"triggers":["project_archived"],"affects":["project status"],"depends_on":["project_id"]}
        },

        {
            name: 'InviteTeamMemberDialog',
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button[data-action='invite']"],
            purpose: 'Open invite member modal',
            contextNeeded: ["workspace_id","current_member_count"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-workspace-id","required":true,"description":"Current workspace"},{"field_name":"current_member_count","selector":".member-count","extraction_method":"textContent","data_type":"number","required":false,"description":"Current team size"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
            relationships: {"triggers":["invite_modal_opened"],"affects":["modal visibility"],"depends_on":["workspace context"]}
        },

        {
            name: 'InviteTeamMemberForm',
            type: 'form',
            pattern_type: 'form_submission,modal_lifecycle',
            selectors: ["form[data-form='invite']"],
            purpose: 'Send team member invitation',
            contextNeeded: ["email","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email address"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
            relationships: {"triggers":["invited_member"],"affects":["invitation list"],"depends_on":["workspace_id"]}
        },

        {
            name: 'RemoveTeamMemberAction',
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-action='remove-member']"],
            purpose: 'Remove team member',
            contextNeeded: ["member_id","member_email","workspace_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-member-id]","fields":[{"field_name":"member_id","selector":"[data-member-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-member-id","required":true,"description":"Member to remove"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["dropdown context"]},
            relationships: {"triggers":["member_removed"],"affects":["member list"],"depends_on":["member_id"]}
        },

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"button[aria-selected='true']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-tab-id","required":true,"description":"Previously active tab"},{"field_name":"new_tab","selector":"button[role='tab']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-tab-id","required":true,"description":"Newly selected tab"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":["aria-selected"]},
            relationships: {"triggers":["tab_switched"],"affects":["visible content"],"depends_on":["tab context"]}
        },

        {
            ...
            contextNeeded: ["full_name","email","user_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[name='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name"},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":["state variables"]},
            relationships: {"triggers":["updated_settings"],"affects":["profile data"],"depends_on":["user_id"]}
        },

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"[data-setting-name]","fields":[{"field_name":"setting_name","selector":"[data-setting-name]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-setting-name","required":true,"description":"Setting identifier"},{"field_name":"previous_state","selector":"button[role='switch']","extraction_method":"aria-attribute","data_type":"boolean","attribute_name":"aria-checked","required":true,"description":"State before toggle"},{"field_name":"new_state","selector":"button[role='switch']","extraction_method":"aria-attribute","data_type":"boolean","attribute_name":"aria-checked","required":true,"description":"State after toggle"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":["checked attribute"]},
            relationships: {"triggers":["preference_changed"],"affects":["notification settings"],"depends_on":["setting_name"]}
        },

        {
            ...
            contextNeeded: ["current_plan","source_page","workspace_id"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-plan","required":false,"description":"Current subscription plan"},{"field_name":"source_page","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-page","required":true,"description":"Page where upgrade clicked"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["window.location.pathname"]},
            relationships: {"triggers":["upgrade_clicked"],"affects":["page navigation"],"depends_on":["workspace context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-action='manage-subscription']"],
            purpose: 'Manage billing subscription',
            contextNeeded: ["workspace_id","current_plan","billing_cycle"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-plan","required":true,"description":"Active subscription plan"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-cycle","required":false,"description":"Billing frequency"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-invoice-id]","fields":[{"field_name":"invoice_id","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-invoice-id","required":true,"description":"Invoice identifier"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["closest invoice row"]},
            relationships: {"triggers":["invoice_downloaded"],"affects":["file download"],"depends_on":["invoice_id"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project identifier"},{"field_name":"task_count","selector":".task-count","extraction_method":"textContent","data_type":"number","required":false,"description":"Number of tasks"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["href attribute"]},
            relationships: {"triggers":["project_viewed"],"affects":["page navigation"],"depends_on":["project_id"]}
        },

        {
            ...
            contextNeeded: ["source_page","workspace_id"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-page","required":true,"description":"Current page location"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["window.location.pathname"]},
            relationships: {"triggers":["navigation_back"],"affects":["page navigation"],"depends_on":["current location"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-15-49qln7ze3jx] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-15-49qln7ze3jx] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-10-15-49qln7ze3jx] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-15-49qln7ze3jx] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-15-49qln7ze3jx] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-15-49qln7ze3jx] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-15-49qln7ze3jx] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
