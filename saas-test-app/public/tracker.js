(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-20-bbdchvbxtn7',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan","field_purpose":"preference"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Billing frequency","field_purpose":"preference"},{"field_name":"total_amount","selector":"body","extraction_method":"textContent","data_type":"number","required":true,"description":"Total charge amount","field_purpose":"metadata"},{"field_name":"payment_fields_completed","selector":"form input","extraction_method":"count","data_type":"array","required":true,"description":"Completed payment fields","field_purpose":"metadata","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["subscription_creation","success_page_redirect"],"depends_on":["payment_fields_valid"]}
        },

        {
            name: 'CheckoutSuccessCTA',
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href*='/dashboard']","button"],
            purpose: 'Navigate to dashboard after upgrade',
            contextNeeded: ["conversion_completed"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"conversion_type","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Type of conversion","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            type: 'form_input',
            pattern_type: 'form_submission',
            selectors: ["input[value*='name']","textarea[value*='description']"],
            purpose: 'Create new project',
            contextNeeded: ["project_name","description","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"project_name","selector":"input[value*='name']","extraction_method":"value","data_type":"string","required":true,"description":"Project name","field_purpose":"metadata"},{"field_name":"project_description","selector":"textarea[value*='description']","extraction_method":"value","data_type":"string","required":false,"description":"Project description","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["project_creation","activity_log"],"depends_on":["workspace_membership"]}
        },

        {
            name: 'ProjectCreateSubmit',
            type: 'button',
            pattern_type: 'form_submission',
            selectors: ["button[onClick*='handleSubmit']","button[type='submit']"],
            purpose: 'Submit new project',
            contextNeeded: ["project_data","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"form_data","selector":"form","extraction_method":"value","data_type":"object","required":true,"description":"All form fields","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["project_list","dashboard_stats"],"depends_on":["form_validation"]}
        },

        {
            ...
            contextNeeded: ["project_id","modal_trigger"],
            ...
            relationships: {"triggers":["button_click"],"affects":["modal_display"],"depends_on":["project_context"]}
        },

        {
            ...
            type: 'form_input',
            pattern_type: 'form_submission',
            selectors: ["input[value*='taskTitle']","textarea[value*='taskDescription']","select"],
            purpose: 'Create task with details',
            contextNeeded: ["title","description","priority","assignee","due_date"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"task_title","selector":"input[value*='taskTitle']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"task_description","selector":"textarea[value*='taskDescription']","extraction_method":"value","data_type":"string","required":false,"description":"Task description","field_purpose":"metadata"},{"field_name":"priority","selector":"select","extraction_method":"value","data_type":"string","required":true,"description":"Task priority level","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select","extraction_method":"value","data_type":"string","required":false,"description":"Assigned team member","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["modal_open"],"affects":["task_list"],"depends_on":["project_context"]}
        },

        {
            ...
            contextNeeded: ["task_id","old_status","new_status"],
            ...
            relationships: {"triggers":["select_change"],"affects":["task_state","activity_log"],"depends_on":["task_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button[onClick*='setEditTaskOpen']"],
            ...
            relationships: {"triggers":["button_click"],"affects":["modal_display"],"depends_on":["task_context"]}
        },

        {
            ...
            selectors: ["button[onClick*='delete']","[role='menuitem']"],
            purpose: 'Delete task',
            contextNeeded: ["task_id","confirmation"],
            ...
            relationships: {"triggers":["menu_item_click"],"affects":["task_list","activity_log"],"depends_on":["task_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[onClick*='archive']"],
            ...
            relationships: {"triggers":["button_click"],"affects":["project_status","activity_log"],"depends_on":["project_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button[onClick*='setInviteDialogOpen']"],
            ...
            relationships: {"triggers":["button_click"],"affects":["modal_display"],"depends_on":["workspace_context"]}
        },

        {
            ...
            type: 'input',
            pattern_type: 'form_submission',
            selectors: ["input[value*='inviteEmail']"],
...

        {
            ...
            type: 'form_input',
            pattern_type: 'form_submission',
            selectors: ["input[value*='fullName']","input[value*='email']"],
            purpose: 'Update user profile',
            contextNeeded: ["full_name","email"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[value*='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true},{"field_name":"email","selector":"input[value*='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["user_profile"],"depends_on":["authentication"]}
        },

        {
            name: 'SettingsNotificationToggle',
            type: 'toggle_switch',
            pattern_type: 'toggle_state',
            selectors: ["[role='switch']","input[type='checkbox']"],
            purpose: 'Toggle notification preferences',
            contextNeeded: ["setting_name","previous_state","new_state"],
            context_collection: {"strategy":"component_props","scope_selector":"[role='switch']","fields":[{"field_name":"setting_name","selector":"[role='switch']","extraction_method":"aria-attribute","data_type":"string","attribute_name":"aria-label","required":true,"description":"Setting being toggled","field_purpose":"preference"},{"field_name":"previous_state","selector":"[role='switch']","extraction_method":"aria-attribute","data_type":"boolean","attribute_name":"aria-checked","required":true,"description":"State before toggle","field_purpose":"preference"},{"field_name":"new_state","selector":"[role='switch']","extraction_method":"aria-attribute","data_type":"boolean","attribute_name":"aria-checked","required":true,"description":"State after toggle","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":["checked"]},
...

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"[role='tab'][data-state='active']","extraction_method":"textContent","data_type":"string","required":true,"description":"Previously active tab","field_purpose":"metadata"},{"field_name":"new_tab","selector":"[role='tab']","extraction_method":"textContent","data_type":"string","required":true,"description":"Newly selected tab","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["pricing_page_view"],"depends_on":["plan_context"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"a[href*='/dashboard/projects/']","extraction_method":"data-attribute","data_type":"string","attribute_name":"href","required":true,"description":"Project identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href"]},
...

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href='/dashboard/projects/new']"],
            purpose: 'Navigate to new project form',
            contextNeeded: ["workspace_id"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["button_click"],"affects":["project_form_view"],"depends_on":["workspace_context"]}
        },

        {
            ...
            contextNeeded: ["limit_type","current_usage","limit"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"limit_context","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Type of limit reached","field_purpose":"metadata"},{"field_name":"current_usage","selector":"[role='dialog']","extraction_method":"textContent","data_type":"number","required":true,"description":"Current usage count","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-20-bbdchvbxtn7] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-20-bbdchvbxtn7] 📊 Tracking 24 discovered components');
      console.log('[demo-test-apps-2025-10-20-bbdchvbxtn7] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-20-bbdchvbxtn7] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-20-bbdchvbxtn7] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-20-bbdchvbxtn7] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-20-bbdchvbxtn7] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
