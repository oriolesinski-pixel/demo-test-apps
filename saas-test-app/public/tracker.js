(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-11-lzmojbpkx4',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[value*='cardNumber']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[value*='expiry']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[value*='cvv']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name","selector":"input[value*='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card","field_purpose":"pii","anonymize":true},{"field_name":"billing_address_completed","selector":"input[value*='billingAddress']","extraction_method":"value","data_type":"boolean","required":true,"description":"Address filled","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_project_count","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Existing project count","field_purpose":"metadata"},{"field_name":"workspace_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace subscription plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["task_form_submit"],"affects":["task_created"],"depends_on":["project_id"]}
        },

        {
            ...
            relationships: {"triggers":["status_change"],"affects":["task_updated"],"depends_on":["task_id"]}
        },

        {
            ...
            selectors: ["button:has(.lucide-more-vertical)"],
            purpose: 'Open task actions menu',
            contextNeeded: ["task_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["task_view"],"affects":["menu_open"],"depends_on":["task_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button:has(.lucide-trash-2)"],
            purpose: 'Delete task',
            contextNeeded: ["task_id","task_title"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["menu_item_click"],"affects":["task_deleted"],"depends_on":["task_id"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace identifier","field_purpose":"metadata"},{"field_name":"current_member_count","selector":"body","extraction_method":"count","data_type":"number","required":true,"description":"Existing team size","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["invite_form_submit"],"affects":["invitation_sent"],"depends_on":["workspace_id"]}
        },

        {
            ...
            relationships: {"triggers":["profile_form_submit"],"affects":["profile_updated"],"depends_on":["user_id"]}
        },
...

        {
            ...
            relationships: {"triggers":["invoice_view"],"affects":["invoice_downloaded"],"depends_on":["invoice_id"]}
        },
...

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button:has(.lucide-arrow-left)","a:has(.lucide-arrow-left)"],
            purpose: 'Navigate back',
            contextNeeded: ["current_page","previous_page"],
            ...
            relationships: {"triggers":["back_click"],"affects":["navigation"],"depends_on":["history"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-11-lzmojbpkx4] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-11-lzmojbpkx4] 📊 Tracking 21 discovered components');
      console.log('[demo-test-apps-2025-12-11-lzmojbpkx4] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-11-lzmojbpkx4] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-11-lzmojbpkx4] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-11-lzmojbpkx4] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-11-lzmojbpkx4] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
