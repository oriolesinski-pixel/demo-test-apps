(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-15-nmdkp7k8w4c',
      ...
      this.componentDetectors = [
        {
            ...
            context_collection: {"strategy":"accumulated_state","scope_selector":"form","fields":[{"field_name":"plan","selector":"input[name='plan']","extraction_method":"value","data_type":"string","required":true,"description":"Selected plan type"},{"field_name":"billing_cycle","selector":"input[name='cycle']","extraction_method":"value","data_type":"string","required":true,"description":"Monthly or annual"},{"field_name":"step","selector":"body","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-step","required":true,"description":"Current checkout step"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":["searchParams"]},
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number","selector":"input[name='cardNumber']","extraction_method":"value","data_type":"string","required":true,"description":"Credit card number"},{"field_name":"expiry","selector":"input[name='expiry']","extraction_method":"value","data_type":"string","required":true,"description":"Card expiry date"},{"field_name":"cvv","selector":"input[name='cvv']","extraction_method":"value","data_type":"string","required":true,"description":"Card CVV"},{"field_name":"cardholder_name","selector":"input[name='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card"},{"field_name":"billing_address","selector":"input[name='billingAddress']","extraction_method":"value","data_type":"string","required":true,"description":"Billing street address"},{"field_name":"city","selector":"input[name='city']","extraction_method":"value","data_type":"string","required":true,"description":"Billing city"},{"field_name":"state","selector":"input[name='state']","extraction_method":"value","data_type":"string","required":true,"description":"Billing state"},{"field_name":"zip","selector":"input[name='zip']","extraction_method":"value","data_type":"string","required":true,"description":"Billing zip code"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form submit"],"affects":["subscription status"],"depends_on":["step 2 reached"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"upgrade_completed","selector":"body","extraction_method":"data-attribute","data_type":"boolean","attribute_name":"data-upgrade-complete","required":true,"description":"Upgrade completion status"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["localStorage"]},
            relationships: {"triggers":["navigation"],"affects":["page transition"],"depends_on":["checkout completion"]}
        },

        {
            ...
            relationships: {"triggers":["form submit"],"affects":["project list"],"depends_on":["workspace membership"]}
        },

        {
            ...
            contextNeeded: ["project_id","modal_state"],
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier"},{"field_name":"previous_status","selector":"select[name='status']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-previous-value","required":true,"description":"Status before change"},{"field_name":"new_status","selector":"select[name='status']","extraction_method":"value","data_type":"string","required":true,"description":"Status after change"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["status change"],"affects":["task state"],"depends_on":["task_id"]}
        },

        {
            name: 'TaskActionsDropdown',
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label='Task actions']"],
            purpose: 'Open task action menu',
            ...
            relationships: {"triggers":["dropdown open"],"affects":["menu visibility"],"depends_on":["task_id"]}
        },

        {
            name: 'TaskEditAction',
            type: 'button',
            pattern_type: 'inline_edit,modal_lifecycle',
            selectors: ["button[data-action='edit']"],
            purpose: 'Open task edit modal',
            contextNeeded: ["task_id","current_values"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to edit"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["modal open"],"affects":["edit modal"],"depends_on":["task_id"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task to delete"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["delete action"],"affects":["task list"],"depends_on":["task_id"]}
        },

        {
            ...
            contextNeeded: ["project_id","previous_status","new_status"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project to archive"},{"field_name":"previous_status","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-status","required":true,"description":"Status before archive"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["archive action"],"affects":["project status"],"depends_on":["project_id"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-workspace-id","required":true,"description":"Current workspace"},{"field_name":"current_member_count","selector":".team-members","extraction_method":"count","data_type":"number","required":false,"description":"Number of team members"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["modal open"],"affects":["invite modal"],"depends_on":["workspace_id"]}
        },

        {
            ...
            relationships: {"triggers":["form submit"],"affects":["invitation list","modal close"],"depends_on":["workspace_id"]}
        },

        {
            name: 'MemberRemoveAction',
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-action='remove-member']"],
            purpose: 'Remove team member',
            contextNeeded: ["member_id","member_email","workspace_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-member-id]","fields":[{"field_name":"member_id","selector":"[data-member-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-member-id","required":true,"description":"Member to remove"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["remove action"],"affects":["member list"],"depends_on":["member_id"]}
        },
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form[data-form='profile']","fields":[{"field_name":"full_name","selector":"input[name='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name"},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form submit"],"affects":["profile data"],"depends_on":["user_id"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form[data-form='workspace']","fields":[{"field_name":"workspace_name","selector":"input[name='workspaceName']","extraction_method":"value","data_type":"string","required":true,"description":"Workspace name"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form submit"],"affects":["workspace data"],"depends_on":["workspace_id"]}
        },
...

        {
            ...
            type: 'toggle',
            pattern_type: 'toggle_state',
            selectors: ["button[data-cycle]"],
            purpose: 'Switch billing cycle',
            contextNeeded: ["previous_cycle","new_cycle","plan"],
            context_collection: {"strategy":"sibling_state","scope_selector":".billing-toggle","fields":[{"field_name":"previous_cycle","selector":"button[aria-selected='true']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-cycle","required":true,"description":"Previous billing cycle"},{"field_name":"new_cycle","selector":"button","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-cycle","required":true,"description":"New billing cycle"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["cycle change"],"affects":["pricing display"],"depends_on":["plan selection"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project identifier"},{"field_name":"project_name","selector":".project-name","extraction_method":"textContent","data_type":"string","required":true,"description":"Project name"},{"field_name":"task_count","selector":".task-count","extraction_method":"textContent","data_type":"number","required":false,"description":"Number of tasks"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["href attribute"]},
            relationships: {"triggers":["navigation"],"affects":["page transition"],"depends_on":["project_id"]}
        },

        {
            name: 'InvoiceDownload',
            type: 'button',
            pattern_type: 'copy_share',
            selectors: ["button[data-action='download-invoice']"],
            purpose: 'Download invoice PDF',
            contextNeeded: ["invoice_id","invoice_date","amount"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-invoice-id]","fields":[{"field_name":"invoice_id","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-invoice-id","required":true,"description":"Invoice identifier"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["download action"],"affects":["file download"],"depends_on":["invoice_id"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-15-nmdkp7k8w4c] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-15-nmdkp7k8w4c] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-10-15-nmdkp7k8w4c] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-15-nmdkp7k8w4c] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-15-nmdkp7k8w4c] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-15-nmdkp7k8w4c] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-15-nmdkp7k8w4c] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
