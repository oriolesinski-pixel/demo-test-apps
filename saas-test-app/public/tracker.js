(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-27-ej18w5ucq6t',
      ...
      this.componentDetectors = [
...

        {
            ...
            selectors: ["button[type='button']",".checkout-continue"],
            purpose: 'Advance to payment step',
            contextNeeded: ["step","plan","cycle","amount"],
            context_collection: {"strategy":"accumulated_state","scope_selector":"form","fields":[{"field_name":"current_step","selector":"body","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-step","required":true,"description":"Current checkout step","field_purpose":"metadata"},{"field_name":"plan_selected","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected subscription plan","field_purpose":"preference"},{"field_name":"total_amount","selector":"body","extraction_method":"textContent","data_type":"number","required":true,"description":"Total checkout amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":true},"fallback_sources":["searchParams","localStorage"]},
            relationships: {"triggers":["step_1_complete"],"affects":["payment_form_display"],"depends_on":["plan_selection"]}
        },

        {
            ...
            selectors: ["form[id*='checkout']","form[id*='payment']"],
            purpose: 'Submit payment information',
            contextNeeded: ["plan","cycle","amount","payment_fields_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"cardholder_name","selector":"input[name*='cardholder']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card","field_purpose":"pii","anonymize":true},{"field_name":"card_number_completed","selector":"input[name*='card']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[name*='expiry']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[name*='cvv']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"billing_address","selector":"input[name*='address']","extraction_method":"value","data_type":"string","required":true,"description":"Billing address","field_purpose":"pii","anonymize":true},{"field_name":"city","selector":"input[name*='city']","extraction_method":"value","data_type":"string","required":true,"description":"City","field_purpose":"pii","anonymize":true},{"field_name":"state","selector":"input[name*='state']","extraction_method":"value","data_type":"string","required":true,"description":"State","field_purpose":"pii","anonymize":true},{"field_name":"zip","selector":"input[name*='zip']","extraction_method":"value","data_type":"string","required":true,"description":"Zip code","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["checkout_step_2_viewed"],"affects":["subscription_activation"],"depends_on":["plan_selection","step_1_complete"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href='/dashboard']","button[href*='dashboard']"],
            purpose: 'Navigate to dashboard after purchase',
            contextNeeded: ["plan_purchased","amount_paid"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"conversion_completed","selector":"body","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"Purchase completed","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["sessionStorage"]},
            relationships: {"triggers":["checkout_complete"],"affects":["dashboard_view"],"depends_on":["payment_success"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"project_count","selector":"[data-project-count]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-project-count","required":false,"description":"Current active projects","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["dashboard_view"],"affects":["project_form"],"depends_on":[]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form","form[id*='project']"],
            ...
            relationships: {"triggers":["new_project_click"],"affects":["project_list","activity_log"],"depends_on":["workspace_membership"]}
        },

        {
            ...
            selectors: ["[role='dialog']","[data-modal='paywall']"],
            purpose: 'Show upgrade prompt at limit',
            contextNeeded: ["limit_type","current_usage","plan"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"limit_context","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-context","required":true,"description":"What limit was hit","field_purpose":"metadata"},{"field_name":"current_usage","selector":"[data-usage]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-usage","required":true,"description":"Current usage count","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[role='dialog']","fields":[{"field_name":"paywall_trigger","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-trigger","required":true,"description":"What triggered paywall","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["paywall_shown"],"affects":["pricing_page"],"depends_on":["limit_reached"]}
        },

        {
            name: 'TaskCreationButton',
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button:has-text('New Task')","button[data-action='create-task']"],
            ...
            relationships: {"triggers":["project_view"],"affects":["task_form"],"depends_on":["project_id"]}
        },
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier","field_purpose":"metadata"},{"field_name":"previous_status","selector":"select[name*='status']","extraction_method":"value","data_type":"string","required":true,"description":"Status before change","field_purpose":"metadata"},{"field_name":"new_status","selector":"select[name*='status']","extraction_method":"value","data_type":"string","required":true,"description":"Status after change","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["task_view"],"affects":["task_state","activity_log"],"depends_on":["task_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button[data-action='edit-task']","button:has(svg.edit)"],
            purpose: 'Open task edit modal',
            contextNeeded: ["task_id","current_values"],
            ...
            relationships: {"triggers":["task_view"],"affects":["edit_modal"],"depends_on":["task_id"]}
        },

        {
            ...
            selectors: ["button[data-action='delete-task']","button:has(svg.trash)"],
            purpose: 'Delete task',
            ...
            relationships: {"triggers":["task_view"],"affects":["task_list","activity_log"],"depends_on":["task_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-action='archive']","button:has-text('Archive')"],
            ...
            relationships: {"triggers":["project_view"],"affects":["project_list","activity_log"],"depends_on":["project_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button:has-text('Invite')","button[data-action='invite']"],
            purpose: 'Open team invite modal',
            contextNeeded: ["workspace_id","current_member_count"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"member_count","selector":"[data-member-count]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-member-count","required":false,"description":"Current team size","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["team_page_view"],"affects":["invite_modal"],"depends_on":["workspace_id"]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form[id*='invite']","[role='dialog'] form"],
            purpose: 'Send team invitation',
            contextNeeded: ["email","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Email to invite","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["invite_button_click"],"affects":["team_list","activity_log"],"depends_on":["workspace_id"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-action='remove-member']","button:has(svg.trash)"],
            ...
            relationships: {"triggers":["team_view"],"affects":["team_list","activity_log"],"depends_on":["member_id"]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form[id*='profile']","form[data-form='profile']"],
            purpose: 'Update user profile',
            contextNeeded: ["full_name","email"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[name*='name']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["settings_view"],"affects":["profile_data"],"depends_on":["user_id"]}
        },

        {
            ...
            type: 'toggle_switch',
            pattern_type: 'toggle_state',
            selectors: ["input[type='checkbox'][role='switch']","[data-notification-toggle]"],
            purpose: 'Toggle notification preferences',
            contextNeeded: ["notification_type","previous_state","new_state"],
            context_collection: {"strategy":"component_props","scope_selector":"label","fields":[{"field_name":"notification_type","selector":"input[type='checkbox']","extraction_method":"data-attribute","data_type":"string","attribute_name":"name","required":true,"description":"Type of notification","field_purpose":"preference"},{"field_name":"enabled","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"Toggle state","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["settings_view"],"affects":["notification_preferences"],"depends_on":["user_id"]}
        },

        {
            ...
            relationships: {"triggers":["billing_view"],"affects":["pricing_page"],"depends_on":["current_plan"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-action='download-invoice']","button:has(svg.download)"],
            ...
            relationships: {"triggers":["billing_view"],"affects":["file_download"],"depends_on":["invoice_id"]}
        },

        {
            ...
            relationships: {"triggers":["settings_view"],"affects":["tab_content"],"depends_on":[]}
        },

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href*='/dashboard/projects/']","[data-project-card]"],
            ...
            relationships: {"triggers":["project_list_view"],"affects":["project_detail"],"depends_on":["project_id"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-page","required":false,"description":"Current page","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["window.location.pathname"]},
            relationships: {"triggers":["page_view"],"affects":["dashboard"],"depends_on":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-27-ej18w5ucq6t] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-27-ej18w5ucq6t] 📊 Tracking 24 discovered components');
      console.log('[demo-test-apps-2025-12-27-ej18w5ucq6t] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-27-ej18w5ucq6t] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-27-ej18w5ucq6t] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-27-ej18w5ucq6t] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-27-ej18w5ucq6t] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
