(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-11-r1dafjskyda',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[type='text']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name","selector":"input","extraction_method":"value","data_type":"string","required":true,"description":"Name on card","field_purpose":"pii","anonymize":true},{"field_name":"billing_address_completed","selector":"input","extraction_method":"value","data_type":"boolean","required":true,"description":"Address fields filled","field_purpose":"pii","anonymize":true},{"field_name":"total_amount","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Total payment amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            relationships: {"triggers":["dashboard_action"],"affects":["project_form_view"],"depends_on":[]}
        },

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["project_created"],"depends_on":["new_project_click"]}
        },
...

        {
            ...
            relationships: {"triggers":["project_view"],"affects":["task_form_open"],"depends_on":["project_id"]}
        },
...

        {
            ...
            relationships: {"triggers":["priority_change"],"affects":["task_updated"],"depends_on":["task_id"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["task_view"],"affects":["edit_modal_open"],"depends_on":["task_id"]}
        },
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace identifier","field_purpose":"metadata"},{"field_name":"current_member_count","selector":"body","extraction_method":"count","data_type":"number","required":false,"description":"Current team size","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["invite_click"],"affects":["invite_modal_open"],"depends_on":["workspace_id"]}
        },

        {
            ...
            relationships: {"triggers":["invite_submit"],"affects":["invitation_sent"],"depends_on":["workspace_id"]}
        },
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true},{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["profile_save"],"affects":["profile_updated"],"depends_on":["user_id"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"workspace_name","selector":"input[type='text']","extraction_method":"value","data_type":"string","required":true,"description":"Workspace name","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["workspace_save"],"affects":["workspace_updated"],"depends_on":["workspace_id"]}
        },
...

        {
            ...
            pattern_type: 'navigation',
            selectors: ["button"],
            purpose: 'Manage billing details',
            ...
            relationships: {"triggers":["billing_view"],"affects":["billing_portal"],"depends_on":["subscription"]}
        },
...

        {
            ...
            relationships: {"triggers":["back_click"],"affects":["page_navigation"],"depends_on":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-11-r1dafjskyda] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-11-r1dafjskyda] 📊 Tracking 26 discovered components');
      console.log('[demo-test-apps-2025-12-11-r1dafjskyda] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-11-r1dafjskyda] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-11-r1dafjskyda] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-11-r1dafjskyda] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-11-r1dafjskyda] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
