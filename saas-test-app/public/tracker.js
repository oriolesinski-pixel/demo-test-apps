(function(root, factory) {
  ...
  console.log('[demo-test-apps-2025-11-12-uzzuajbbkn] 🚀 Analytics tracker script loaded and executing...');
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-11-12-uzzuajbbkn',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[name='cardNumber']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[name='expiry']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry date filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[name='cvv']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name","selector":"input[name='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card","field_purpose":"pii","anonymize":true},{"field_name":"billing_address","selector":"input[name='billingAddress']","extraction_method":"value","data_type":"string","required":true,"description":"Billing address","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace","field_purpose":"metadata"},{"field_name":"project_count","selector":".stats","extraction_method":"textContent","data_type":"number","required":false,"description":"Current project count","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["dashboard_view"],"affects":["project_form"],"depends_on":["workspace_access"]}
        },
...

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["task_modal"],"depends_on":["project_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["invite_click"],"affects":["invite_modal"],"depends_on":["workspace_limits"]}
        },
...

        {
            ...
            selectors: ["[role='tab']",".tabs-trigger"],
            ...
            relationships: {"triggers":["tab_click"],"affects":["tab_content"],"depends_on":["settings_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["upgrade_click"],"affects":["pricing_page"],"depends_on":["workspace_context"]}
        },

        {
            ...
            pattern_type: 'navigation',
            selectors: ["button"],
            purpose: 'Manage subscription settings',
            contextNeeded: ["plan","billing_cycle","workspace_id"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Active subscription plan","field_purpose":"metadata"},{"field_name":"billing_cycle","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Monthly or annual","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["manage_click"],"affects":["billing_portal"],"depends_on":["subscription_context"]}
        },

        {
            ...
            relationships: {"triggers":["download_click"],"affects":["file_download"],"depends_on":["invoice_context"]}
        },

        {
            ...
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"a","extraction_method":"data-attribute","data_type":"string","attribute_name":"href","required":true,"description":"Project to view","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href"]},
            relationships: {"triggers":["card_click"],"affects":["project_detail"],"depends_on":["project_context"]}
        },

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: [".activity-item","a"],
            purpose: 'View activity detail',
            contextNeeded: ["activity_type","entity_id","user_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-activity-id]","fields":[{"field_name":"activity_type","selector":"[data-activity-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-activity-type","required":true,"description":"Type of activity","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["activity_click"],"affects":["entity_view"],"depends_on":["activity_context"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-11-12-uzzuajbbkn] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-11-12-uzzuajbbkn] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-11-12-uzzuajbbkn] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-11-12-uzzuajbbkn] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-11-12-uzzuajbbkn] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-11-12-uzzuajbbkn] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    try {
      ...
      console.log('[demo-test-apps-2025-11-12-uzzuajbbkn] ✅ AI-Enhanced Analytics tracker initialized successfully');
      console.log('[demo-test-apps-2025-11-12-uzzuajbbkn] 📊 Tracking', window.analytics.componentDetectors?.length || 0, 'components');
    } catch (error) {
      console.error('[demo-test-apps-2025-11-12-uzzuajbbkn] ❌ Analytics tracker initialization FAILED:', error);
      console.error('[demo-test-apps-2025-11-12-uzzuajbbkn] Error details:', error.message, error.stack);
    }
  }
