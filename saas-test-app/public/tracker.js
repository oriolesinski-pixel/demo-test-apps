(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-12-14-5fiy9or5h85',
      ...
      this.componentDetectors = [
        {
            ...
            selectors: ["[data-plan-selector]",".plan-select"],
            purpose: 'Select subscription plan',
            contextNeeded: ["plan","cycle","base_price","tax","total"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"plan","selector":"searchParams.plan","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Selected plan type","field_purpose":"preference"},{"field_name":"cycle","selector":"searchParams.cycle","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Billing cycle","field_purpose":"preference"},{"field_name":"total","selector":".total-amount","extraction_method":"textContent","data_type":"number","required":true,"description":"Total checkout amount","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":["URL params"]},
            relationships: {"triggers":["URL navigation from pricing"],"affects":["checkout_total","payment_form"],"depends_on":["pricing_page_selection"]}
        },

        {
            ...
            selectors: ["button[data-step='continue']",".continue-to-payment"],
            purpose: 'Continue to payment step',
            contextNeeded: ["step","plan","cycle","billing_address_complete"],
            context_collection: {"strategy":"accumulated_state","scope_selector":"form","fields":[{"field_name":"step","selector":"[data-step]","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Current checkout step","field_purpose":"metadata"},{"field_name":"billing_address","selector":"input[name='billingAddress']","extraction_method":"value","data_type":"string","required":false,"description":"Billing address","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variable"]},
            relationships: {"triggers":["step_1_completion"],"affects":["step_2_display","payment_form_visibility"],"depends_on":["billing_info_validation"]}
        },

        {
            ...
            selectors: ["form[data-checkout-form]","#payment-form"],
            purpose: 'Submit payment information',
            contextNeeded: ["plan","cycle","total","payment_fields_completed"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number","selector":"input[name='cardNumber']","extraction_method":"value","data_type":"string","required":true,"description":"Credit card number","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry","selector":"input[name='expiry']","extraction_method":"value","data_type":"string","required":true,"description":"Card expiry date","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv","selector":"input[name='cvv']","extraction_method":"value","data_type":"string","required":true,"description":"Card CVV","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name","selector":"input[name='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Cardholder name","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["submit_button_click"],"affects":["subscription_creation","success_page_redirect"],"depends_on":["payment_validation"]}
        },

        {
            ...
            selectors: ["a[href='/dashboard']",".view-dashboard-btn"],
            purpose: 'Navigate to dashboard after upgrade',
            contextNeeded: ["plan","upgrade_completed"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"upgrade_completed","selector":"[data-upgrade-status]","extraction_method":"data-attribute","data_type":"boolean","required":true,"description":"Upgrade completion status","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["page context"]},
            relationships: {"triggers":["checkout_success"],"affects":["dashboard_navigation"],"depends_on":["payment_completion"]}
        },

        {
            ...
            selectors: ["a[href='/pricing']","button.upgrade-btn"],
            purpose: 'Navigate to pricing page',
            contextNeeded: ["current_plan","workspace_id"],
            ...
            relationships: {"triggers":["user_click"],"affects":["pricing_page_navigation"],"depends_on":["authentication"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href='/dashboard/projects/new']",".new-project-btn"],
            ...
            relationships: {"triggers":["user_click"],"affects":["project_form_display"],"depends_on":["workspace_membership"]}
        },
...

        {
            ...
            selectors: ["[data-paywall-modal]",".paywall-dialog"],
            purpose: 'Show upgrade prompt at limit',
            contextNeeded: ["context","current_usage","limit","plan"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"context","selector":"[data-context]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Paywall trigger context","field_purpose":"metadata"},{"field_name":"current_usage","selector":"[data-usage]","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Current usage count","field_purpose":"metadata"},{"field_name":"limit","selector":"[data-limit]","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Plan limit","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
            relationships: {"triggers":["limit_reached"],"affects":["upgrade_flow"],"depends_on":["plan_limits"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button[data-create-task]",".create-task-btn"],
            purpose: 'Open task creation modal',
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["URL params"]},
            relationships: {"triggers":["user_click"],"affects":["task_form_display"],"depends_on":["project_context"]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form[data-task-form]","#create-task-form"],
            purpose: 'Create new task',
            contextNeeded: ["title","description","priority","assigned_to","due_date","project_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"title","selector":"input[name='title']","extraction_method":"value","data_type":"string","required":true,"description":"Task title","field_purpose":"metadata"},{"field_name":"description","selector":"textarea[name='description']","extraction_method":"value","data_type":"string","required":false,"description":"Task description","field_purpose":"metadata"},{"field_name":"priority","selector":"select[name='priority']","extraction_method":"value","data_type":"string","required":true,"description":"Task priority","field_purpose":"preference"},{"field_name":"assigned_to","selector":"select[name='assignedTo']","extraction_method":"value","data_type":"string","required":false,"description":"Assigned user ID","field_purpose":"metadata"},{"field_name":"due_date","selector":"input[name='dueDate']","extraction_method":"value","data_type":"string","required":false,"description":"Task due date","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["task_creation","project_update"],"depends_on":["project_context"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Task identifier","field_purpose":"metadata"},{"field_name":"status","selector":"select[name='status']","extraction_method":"value","data_type":"string","required":true,"description":"Task status","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":["task data"]},
            relationships: {"triggers":["dropdown_change"],"affects":["task_update","activity_log"],"depends_on":["task_context"]}
        },

        {
            ...
            type: 'select_dropdown',
            pattern_type: 'toggle_state',
            selectors: ["select[name='priority']","[data-task-priority]"],
            purpose: 'Update task priority',
            contextNeeded: ["task_id","previous_priority","new_priority"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Task identifier","field_purpose":"metadata"},{"field_name":"priority","selector":"select[name='priority']","extraction_method":"value","data_type":"string","required":true,"description":"Task priority","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":["task data"]},
            relationships: {"triggers":["dropdown_change"],"affects":["task_update"],"depends_on":["task_context"]}
        },

        {
            ...
            selectors: ["button[data-delete-task]",".delete-task-btn"],
            purpose: 'Delete task',
            ...
            relationships: {"triggers":["user_click"],"affects":["task_deletion","project_update"],"depends_on":["task_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-archive-project]",".archive-project-btn"],
            purpose: 'Archive project',
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["URL params"]},
            relationships: {"triggers":["user_click"],"affects":["project_status_update"],"depends_on":["project_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button[data-invite-member]",".invite-member-btn"],
            purpose: 'Open team invite modal',
            contextNeeded: ["workspace_id","current_member_count"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"member_count","selector":"[data-member-count]","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Current member count","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["team data"]},
            relationships: {"triggers":["user_click"],"affects":["invite_form_display"],"depends_on":["workspace_context"]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form[data-invite-form]","#invite-member-form"],
            purpose: 'Send team invitation',
            contextNeeded: ["email","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"email","selector":"input[name='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["invitation_creation"],"depends_on":["workspace_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-remove-member]",".remove-member-btn"],
            purpose: 'Remove team member',
            contextNeeded: ["member_id","workspace_id"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-member-id]","fields":[{"field_name":"member_id","selector":"[data-member-id]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Member identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["member context"]},
            relationships: {"triggers":["user_click"],"affects":["member_removal"],"depends_on":["member_context"]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form[data-profile-form]","#profile-settings-form"],
            purpose: 'Update user profile',
            contextNeeded: ["full_name","email"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[name='fullName']","extraction_method":"value","data_type":"string","required":true,"description":"User full name","field_purpose":"pii","anonymize":true},{"field_name":"email","selector":"input[name='email']","extraction_method":"value","data_type":"string","required":true,"description":"User email","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["profile_update"],"depends_on":["user_context"]}
        },

        {
            ...
            type: 'form',
            pattern_type: 'form_submission',
            selectors: ["form[data-workspace-form]","#workspace-settings-form"],
            purpose: 'Update workspace settings',
            contextNeeded: ["workspace_name","workspace_id"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"workspace_name","selector":"input[name='workspaceName']","extraction_method":"value","data_type":"string","required":true,"description":"Workspace name","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["workspace_update"],"depends_on":["workspace_context"]}
        },

        {
            ...
            type: 'toggle_switch',
            pattern_type: 'toggle_state',
            selectors: ["input[type='checkbox'][data-notification]",".notification-toggle"],
            purpose: 'Toggle notification preferences',
            contextNeeded: ["notification_type","enabled"],
            context_collection: {"strategy":"component_props","scope_selector":"input[type='checkbox']","fields":[{"field_name":"notification_type","selector":"input[type='checkbox']","extraction_method":"data-attribute","attribute_name":"data-notification","data_type":"string","required":true,"description":"Notification type","field_purpose":"preference"},{"field_name":"enabled","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"Toggle state","field_purpose":"preference"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["toggle_click"],"affects":["preference_update"],"depends_on":["user_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["a[href='/pricing']",".upgrade-plan-btn"],
            purpose: 'Navigate to pricing from billing',
            contextNeeded: ["current_plan","workspace_id"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"[data-plan]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current plan","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["workspace data"]},
            relationships: {"triggers":["user_click"],"affects":["pricing_navigation"],"depends_on":["workspace_context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[data-download-invoice]",".download-invoice-btn"],
            purpose: 'Download invoice PDF',
            contextNeeded: ["invoice_id","invoice_date"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-invoice-id]","fields":[{"field_name":"invoice_id","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Invoice identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["invoice context"]},
            relationships: {"triggers":["user_click"],"affects":["invoice_download"],"depends_on":["invoice_context"]}
        },

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"tab_id","selector":"button[role='tab']","extraction_method":"data-attribute","attribute_name":"data-value","data_type":"string","required":true,"description":"Tab identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":["aria-selected"]},
            relationships: {"triggers":["tab_click"],"affects":["tab_content_display"],"depends_on":["settings_context"]}
        },

        {
            ...
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Project identifier","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href attribute"]},
            relationships: {"triggers":["user_click"],"affects":["project_detail_navigation"],"depends_on":["project_context"]}
        },

        {
            ...
            type: 'link',
            pattern_type: 'navigation',
            selectors: ["a[href='/dashboard']",".back-to-dashboard"],
            purpose: 'Navigate back to dashboard',
            contextNeeded: ["current_page"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_path","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Current page path","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["window.location"]},
            relationships: {"triggers":["user_click"],"affects":["dashboard_navigation"],"depends_on":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-12-14-5fiy9or5h85] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-12-14-5fiy9or5h85] 📊 Tracking 25 discovered components');
      console.log('[demo-test-apps-2025-12-14-5fiy9or5h85] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-12-14-5fiy9or5h85] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-12-14-5fiy9or5h85] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-12-14-5fiy9or5h85] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-12-14-5fiy9or5h85] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
