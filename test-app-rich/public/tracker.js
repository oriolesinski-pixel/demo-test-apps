(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-05-jsqif5dnh29',
      ...
      this.componentDetectors = [
        {
            name: 'LoginButton',
            type: 'button',
            selectors: [".appearance-none.rounded-none.relative.block.w-full.px-3.py-2.border.border-gray-300.placeholder-gray-500.text-gray-900.rounded-t-md.focus:outline-none.focus:ring-blue-500.focus:border-blue-500.focus:z-10.sm:text-sm"],
...

        {
            ...
            purpose: 'Increase/decrease product quantity in cart',
        ...
        {
            name: 'SubmitShippingForm',
            type: 'form',
            selectors: ["form.space-y-4"],
            purpose: 'Proceed to payment page with shipping information',
            contextNeeded: ["firstName","lastName","email","phone","address","city","state","zipCode","country"],
            contextCollection: {"search_parents":["form.space-y-4"],"extract_fields":["firstName","lastName","email","phone","address","city","state","zipCode","country"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'SubmitPaymentForm',
            type: 'form',
            selectors: ["form.space-y-6"],
            purpose: 'Process payment and complete order',
            contextNeeded: ["cardNumber","cardName","expiryDate","cvv","saveCard"],
            contextCollection: {"search_parents":["form.space-y-6"],"extract_fields":["cardNumber","cardName","expiryDate","cvv","saveCard"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextCollection: {"search_parents":[],"extract_fields":["cart-items"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for demo-test-apps-2025-10-05-jsqif5dnh29');
