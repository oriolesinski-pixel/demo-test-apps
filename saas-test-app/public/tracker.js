(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-10-15-p2w0l70pwva',
      ...
      this.componentDetectors = [
...

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number","selector":"input[name='cardNumber']","extraction_method":"value","data_type":"string","required":true,"description":"Credit card number"},{"field_name":"expiry","selector":"input[name='expiry']","extraction_method":"value","data_type":"string","required":true,"description":"Card expiration date"},{"field_name":"cvv","selector":"input[name='cvv']","extraction_method":"value","data_type":"string","required":true,"description":"Card security code"},{"field_name":"cardholder_name","selector":"input[name='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card"},{"field_name":"billing_address","selector":"input[name='billingAddress']","extraction_method":"value","data_type":"string","required":true,"description":"Billing street address"},{"field_name":"city","selector":"input[name='city']","extraction_method":"value","data_type":"string","required":true,"description":"Billing city"},{"field_name":"state","selector":"input[name='state']","extraction_method":"value","data_type":"string","required":true,"description":"Billing state"},{"field_name":"zip","selector":"input[name='zip']","extraction_method":"value","data_type":"string","required":true,"description":"Billing zip code"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
            relationships: {"triggers":["checkout_completed"],"affects":["subscription status"],"depends_on":["plan selection","step 2"]}
        },

        {
            ...
            selectors: ["a[href='/pricing']"],
            purpose: 'Return to pricing page',
            contextNeeded: ["current_step","form_data"],
            context_collection: {"strategy":"component_props","scope_selector":"body","fields":[{"field_name":"current_step","selector":"body","extraction_method":"data-attribute","data_type":"number","required":false,"description":"Step user was on"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["checkout_abandoned"],"affects":["navigation"],"depends_on":[]}
        },
...

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["a[href='/dashboard/projects/new'] button","button:has-text('New Project')"],
            purpose: 'Navigate to create project',
            contextNeeded: ["workspace_id","current_project_count"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Current workspace"},{"field_name":"current_project_count","selector":".project-count","extraction_method":"textContent","data_type":"number","required":false,"description":"Number of active projects"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["new_project_clicked"],"affects":["navigation"],"depends_on":["workspace membership"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["a[href='/pricing'] button","button:has-text('Upgrade')"],
            purpose: 'Navigate to pricing page',
            contextNeeded: ["current_plan","context"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"User's current plan"},{"field_name":"context","selector":"body","extraction_method":"data-attribute","data_type":"string","required":false,"description":"Where upgrade clicked"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["upgrade_clicked"],"affects":["navigation"],"depends_on":["plan status"]}
        },

        {
            ...
            relationships: {"triggers":["created_project","paywall_encountered"],"affects":["project list"],"depends_on":["workspace","plan limits"]}
        },

        {
            ...
            selectors: ["button:has-text('New Task')","button:has-text('Create Task')"],
            purpose: 'Open task creation modal',
            contextNeeded: ["project_id","project_name"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project for new task"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["URL params"]},
            relationships: {"triggers":["task_modal_opened"],"affects":["modal state"],"depends_on":["project context"]}
        },
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task being updated"},{"field_name":"previous_status","selector":"select[name='status']","extraction_method":"value","data_type":"string","required":true,"description":"Status before change"},{"field_name":"new_status","selector":"select[name='status']","extraction_method":"value","data_type":"string","required":true,"description":"Status after change"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["task_status_changed"],"affects":["task state"],"depends_on":["task context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'item_selection',
            selectors: ["button[aria-label='Task actions']","[data-task-menu]"],
            purpose: 'Open task actions menu',
            contextNeeded: ["task_id","task_status"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task for actions"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["task_menu_opened"],"affects":["menu state"],"depends_on":["task context"]}
        },

        {
            ...
            relationships: {"triggers":["task_deleted"],"affects":["task list"],"depends_on":["task context"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project to archive"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["project_archived"],"affects":["project status"],"depends_on":["project context"]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'modal_lifecycle',
            selectors: ["button:has-text('Invite')"],
            purpose: 'Open invite modal',
            contextNeeded: ["workspace_id","current_member_count"],
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"workspace_id","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Workspace for invite"},{"field_name":"current_member_count","selector":".member-count","extraction_method":"textContent","data_type":"number","required":false,"description":"Current team size"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["invite_modal_opened"],"affects":["modal state"],"depends_on":["workspace"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["state variables"]},
            relationships: {"triggers":["invited_member"],"affects":["team members"],"depends_on":["workspace"]}
        },

        {
            ...
            relationships: {"triggers":["member_removed"],"affects":["team members"],"depends_on":["member context"]}
        },

        {
            ...
            contextNeeded: ["full_name","workspace_name","email_notifications","task_updates","weekly_digest"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"full_name","selector":"input[name='fullName']","extraction_method":"value","data_type":"string","required":false,"description":"User full name"},{"field_name":"workspace_name","selector":"input[name='workspaceName']","extraction_method":"value","data_type":"string","required":false,"description":"Workspace name"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":["state variables"]},
            relationships: {"triggers":["updated_settings"],"affects":["profile","workspace"],"depends_on":["user context"]}
        },

        {
            ...
            context_collection: {"strategy":"component_props","scope_selector":"[data-setting]","fields":[{"field_name":"setting_name","selector":"[data-setting]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-setting","required":true,"description":"Setting being toggled"},{"field_name":"previous_state","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"State before toggle"},{"field_name":"new_state","selector":"input[type='checkbox']","extraction_method":"checked","data_type":"boolean","required":true,"description":"State after toggle"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["setting_changed"],"affects":["preferences"],"depends_on":["user settings"]}
        },

        {
            ...
            context_collection: {"strategy":"sibling_state","scope_selector":"[role='tablist']","fields":[{"field_name":"previous_tab","selector":"[role='tab'][aria-selected='true']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-tab","required":true,"description":"Tab before switch"},{"field_name":"new_tab","selector":"[role='tab']","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-tab","required":true,"description":"Tab after switch"}],"state_tracking":{"track_previous_value":true,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["tab_switched"],"affects":["visible content"],"depends_on":["tab state"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"current_plan","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"User's plan"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["billing_viewed"],"affects":["navigation"],"depends_on":["subscription"]}
        },

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[data-invoice-id]","fields":[{"field_name":"invoice_id","selector":"[data-invoice-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-invoice-id","required":true,"description":"Invoice to download"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["invoice_downloaded"],"affects":["download"],"depends_on":["invoice context"]}
        },

        {
            ...
            contextNeeded: ["project_id","project_name","task_count"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-project-id]","fields":[{"field_name":"project_id","selector":"[data-project-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-project-id","required":true,"description":"Project clicked"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["href attribute"]},
            relationships: {"triggers":["project_viewed"],"affects":["navigation"],"depends_on":["project list"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-10-15-p2w0l70pwva] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-10-15-p2w0l70pwva] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-10-15-p2w0l70pwva] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-10-15-p2w0l70pwva] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-10-15-p2w0l70pwva] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-10-15-p2w0l70pwva] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    ...
    console.log('[demo-test-apps-2025-10-15-p2w0l70pwva] ✅ AI-Enhanced Analytics tracker with new event schema initialized');
  }
