(function(root, factory) {
  ...
  console.log('[demo-test-apps-2025-11-10-qrjra4x6308] 🚀 Analytics tracker script loaded and executing...');
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-11-10-qrjra4x6308',
      ...
      this.componentDetectors = [
...

        {
            ...
            relationships: {"triggers":["dashboard_view"],"affects":["project_form_display"],"depends_on":["authentication"]}
        },

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["project_created","paywall_check"],"depends_on":["workspace_membership"]}
        },

        {
            ...
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"trigger_context","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"What triggered paywall","field_purpose":"metadata"},{"field_name":"current_usage","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Current resource count","field_purpose":"metadata"},{"field_name":"limit","selector":"body","extraction_method":"data-attribute","data_type":"number","required":true,"description":"Plan limit reached","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["component_props"]},
...

        {
            ...
            context_collection: {"strategy":"parent_data","scope_selector":"[role='dialog']","fields":[{"field_name":"paywall_context","selector":"[role='dialog']","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Paywall trigger reason","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["modal_state"]},
            relationships: {"triggers":["paywall_shown"],"affects":["pricing_page_view"],"depends_on":["limit_reached"]}
        },
...

        {
            ...
            relationships: {"triggers":["dropdown_change"],"affects":["task_updated"],"depends_on":["task_id"]}
        },

        {
            ...
            relationships: {"triggers":["task_view"],"affects":["edit_modal_display"],"depends_on":["task_id"]}
        },
...

        {
            ...
            relationships: {"triggers":["team_page_view"],"affects":["invite_modal_display"],"depends_on":["workspace_membership"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[type='email']","extraction_method":"value","data_type":"string","required":true,"description":"Invitee email address","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":["component_state"]},
...

        {
            ...
            relationships: {"triggers":["remove_click"],"affects":["member_removed"],"depends_on":["member_id"]}
        },
...

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["workspace_updated"],"depends_on":["workspace_id"]}
        },
...

        {
            ...
            relationships: {"triggers":["billing_page_view"],"affects":["pricing_page_view"],"depends_on":["current_plan"]}
        },
...

        {
            ...
            relationships: {"triggers":["tab_click"],"affects":["tab_content_display"],"depends_on":["settings_page_load"]}
        },

        {
            ...
            relationships: {"triggers":["project_list_view"],"affects":["project_detail_view"],"depends_on":["project_id"]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_location","selector":"body","extraction_method":"data-attribute","data_type":"string","required":true,"description":"Where upgrade clicked","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["url_path"]},
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-11-10-qrjra4x6308] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-11-10-qrjra4x6308] 📊 Tracking 25 discovered components');
      console.log('[demo-test-apps-2025-11-10-qrjra4x6308] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-11-10-qrjra4x6308] 📍 Session ID:', this.sessionId);
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-11-10-qrjra4x6308] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-11-10-qrjra4x6308] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    try {
      ...
      console.log('[demo-test-apps-2025-11-10-qrjra4x6308] ✅ AI-Enhanced Analytics tracker initialized successfully');
      console.log('[demo-test-apps-2025-11-10-qrjra4x6308] 📊 Tracking', window.analytics.componentDetectors?.length || 0, 'components');
    } catch (error) {
      console.error('[demo-test-apps-2025-11-10-qrjra4x6308] ❌ Analytics tracker initialization FAILED:', error);
      console.error('[demo-test-apps-2025-11-10-qrjra4x6308] Error details:', error.message, error.stack);
    }
  }
