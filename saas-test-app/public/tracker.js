(function(root, factory) {
  ...
  console.log('[demo-test-apps-2025-11-05-s0xxdygqqaj] 🚀 Analytics tracker script loaded and executing...');
  ...
  class AnalyticsTracker {
    constructor() {
      ...
      this.config = {
        appKey: 'demo-test-apps-2025-11-05-s0xxdygqqaj',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextNeeded: ["card_fields_completed","billing_info","plan","amount"],
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"card_number_completed","selector":"input[name='cardNumber']","extraction_method":"value","data_type":"boolean","required":true,"description":"Card number field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"expiry_completed","selector":"input[name='expiry']","extraction_method":"value","data_type":"boolean","required":true,"description":"Expiry field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cvv_completed","selector":"input[name='cvv']","extraction_method":"value","data_type":"boolean","required":true,"description":"CVV field filled","field_purpose":"pci_protected","anonymize":true},{"field_name":"cardholder_name","selector":"input[name='cardholderName']","extraction_method":"value","data_type":"string","required":true,"description":"Name on card","field_purpose":"pii","anonymize":true},{"field_name":"billing_address","selector":"input[name='billingAddress']","extraction_method":"value","data_type":"string","required":true,"description":"Billing street address","field_purpose":"pii","anonymize":true},{"field_name":"city","selector":"input[name='city']","extraction_method":"value","data_type":"string","required":true,"description":"Billing city","field_purpose":"pii","anonymize":true},{"field_name":"state","selector":"input[name='state']","extraction_method":"value","data_type":"string","required":true,"description":"Billing state","field_purpose":"pii","anonymize":true},{"field_name":"zip","selector":"input[name='zip']","extraction_method":"value","data_type":"string","required":true,"description":"Billing zip code","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
...

        {
            ...
            contextNeeded: ["conversion_completed","plan"],
            ...
            relationships: {"triggers":["checkout_success"],"affects":["dashboard_entry"],"depends_on":["payment_completed"]}
        },

        {
            ...
            relationships: {"triggers":["dashboard_action"],"affects":["project_form_display"],"depends_on":[]}
        },
...

        {
            ...
            selectors: ["[data-paywall-modal]"],
            purpose: 'Show upgrade prompt at limit',
            contextNeeded: ["limit_type","current_usage","plan"],
            context_collection: {"strategy":"modal_scope","scope_selector":"[role='dialog']","fields":[{"field_name":"limit_context","selector":"[data-limit-type]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-limit-type","required":true,"description":"Type of limit reached","field_purpose":"metadata"},{"field_name":"current_usage","selector":"[data-current-usage]","extraction_method":"data-attribute","data_type":"number","attribute_name":"data-current-usage","required":true,"description":"Current usage count","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["limit_reached"],"affects":["upgrade_consideration"],"depends_on":["plan_limits"]}
        },

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["task_modal_open"],"depends_on":["project_context"]}
        },
...

        {
            ...
            relationships: {"triggers":["dropdown_change"],"affects":["task_status_updated"],"depends_on":["task_id"]}
        },

        {
            ...
            type: 'select_dropdown',
            pattern_type: 'toggle_state',
            selectors: ["select[name='taskPriority']"],
            purpose: 'Set task priority',
            contextNeeded: ["task_id","previous_priority","new_priority"],
            context_collection: {"strategy":"parent_data","scope_selector":"[data-task-id]","fields":[{"field_name":"task_id","selector":"[data-task-id]","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-task-id","required":true,"description":"Task identifier","field_purpose":"metadata"},{"field_name":"previous_priority","selector":"select[name='taskPriority']","extraction_method":"value","data_type":"string","required":true,"description":"Priority before change","field_purpose":"metadata"},{"field_name":"new_priority","selector":"select[name='taskPriority']","extraction_method":"value","data_type":"string","required":true,"description":"Priority after change","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":true,"track_change_delta":true,"track_timing":false},"fallback_sources":[]},
            relationships: {"triggers":["dropdown_change"],"affects":["task_priority_updated"],"depends_on":["task_id"]}
        },

        {
            ...
            relationships: {"triggers":["delete_click"],"affects":["task_deleted"],"depends_on":["task_id"]}
        },

        {
            ...
            relationships: {"triggers":["archive_click"],"affects":["project_archived"],"depends_on":["project_id"]}
        },

        {
            ...
            relationships: {"triggers":["button_click"],"affects":["invite_modal_open"],"depends_on":["workspace_membership"]}
        },

        {
            ...
            context_collection: {"strategy":"form_state","scope_selector":"form","fields":[{"field_name":"invite_email","selector":"input[name='inviteEmail']","extraction_method":"value","data_type":"string","required":true,"description":"Email to invite","field_purpose":"pii","anonymize":true}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":true},"fallback_sources":[]},
            relationships: {"triggers":["form_submit"],"affects":["invitation_sent"],"depends_on":["workspace_id"]}
        },

        {
            ...
            relationships: {"triggers":["form_submit"],"affects":["profile_updated"],"depends_on":["user_id"]}
        },
...

        {
            ...
            relationships: {"triggers":["tab_click"],"affects":["tab_content_display"],"depends_on":[]}
        },

        {
            ...
            context_collection: {"strategy":"global_context","scope_selector":"body","fields":[{"field_name":"source_page","selector":"body","extraction_method":"data-attribute","data_type":"string","attribute_name":"data-page","required":false,"description":"Page where upgrade clicked","field_purpose":"metadata"}],"state_tracking":{"track_previous_value":false,"track_change_delta":false,"track_timing":false},"fallback_sources":["window.location.pathname"]},
            relationships: {"triggers":["upgrade_click"],"affects":["pricing_page_view"],"depends_on":[]}
        },

        {
            ...
            type: 'button',
            pattern_type: 'navigation',
            selectors: ["button:has-text('Manage Billing')"],
            purpose: 'Navigate to billing management',
            ...
            relationships: {"triggers":["button_click"],"affects":["billing_portal_open"],"depends_on":["subscription_active"]}
        },

        {
            ...
            relationships: {"triggers":["download_click"],"affects":["invoice_downloaded"],"depends_on":["invoice_id"]}
        },
    ...
    initAutoTracking() {
      console.log('[demo-test-apps-2025-11-05-s0xxdygqqaj] 🤖 AI-Enhanced Analytics initialized');
      console.log('[demo-test-apps-2025-11-05-s0xxdygqqaj] 📊 Tracking 22 discovered components');
      console.log('[demo-test-apps-2025-11-05-s0xxdygqqaj] 🔑 User ID:', this.userId);
      console.log('[demo-test-apps-2025-11-05-s0xxdygqqaj] 📍 Session ID:', this.sessionId);
    ...
    calculateSelectorSpecificity(selector, element) {
      ...
      const attrCount = (selector.split('[').length - 1);
      score += attrCount * 15;
    ...
    extractContext(element, componentInfo) {
      ...
      if (!componentInfo || !componentInfo.context_collection) {
        // Fallback 1: Extract from nearest form (including modal forms and associated forms)
        let form = element.closest('form');
        
        // Check if button has form attribute (form="form-id")
        if (!form && element.hasAttribute && element.hasAttribute('form')) {
        ...
        // If still no form, check parent container for any form
        if (!form) {
          const container = element.closest('[class*="form"], [class*="settings"], [class*="profile"]');
          if (container) {
    ...
    getFormFieldValues(form) {
      ...
      try {
        ...
        // ALWAYS extract from input elements directly (even if FormData worked)
        // This catches inputs without name attributes
        const inputs = form.querySelectorAll('input:not([type="password"]), textarea, select');
        inputs.forEach(input => {
          // Get field identifier
          const key = input.name || input.id || input.getAttribute('placeholder') || input.getAttribute('aria-label');
          if (!key) return;
          ...
          if (value === '' || value === null || data[key]) return;
    ...
    trackAllClicks() {
      document.addEventListener('click', (e) => {
        ...
        if (clickable || componentInfo) {
          ...
          let contextData = componentInfo ? this.extractContext(element, componentInfo) : {};
          
          // ALWAYS try to extract form context for buttons (especially save/submit buttons)
          if (Object.keys(contextData).length === 0) {
            contextData = this.extractContext(element, null);
          }
    ...
    flush() {
      ...
      .then(response => {
        if (!response.ok) {
          console.error('[demo-test-apps-2025-11-05-s0xxdygqqaj] Analytics flush failed:', response.status);
      ...
      .catch(err => {
        console.error('[demo-test-apps-2025-11-05-s0xxdygqqaj] Analytics flush error:', err);
        // Re-add to queue and persist on failure
        this.eventQueue.unshift(...batch);
        this.saveQueueToStorage();
      });
  ...
  if (typeof window !== 'undefined' && !window.analytics) {
    try {
      ...
      console.log('[demo-test-apps-2025-11-05-s0xxdygqqaj] ✅ AI-Enhanced Analytics tracker initialized successfully');
      console.log('[demo-test-apps-2025-11-05-s0xxdygqqaj] 📊 Tracking', window.analytics.componentDetectors?.length || 0, 'components');
    } catch (error) {
      console.error('[demo-test-apps-2025-11-05-s0xxdygqqaj] ❌ Analytics tracker initialization FAILED:', error);
      console.error('[demo-test-apps-2025-11-05-s0xxdygqqaj] Error details:', error.message, error.stack);
    }
  }
